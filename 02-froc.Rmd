...
```{r froc-paradigm-4, echo=FALSE, out.width="300pt", fig.align='center', fig.cap="Observer performance paradigms in current usage: Upper Left -- ROC, Upper Right -- FROC, Lower Left -- LROC, Lower Right -- ROI. The arrows point to two lesions and the light-shaded crosses indicate suspicious regions. A marked suspicious region is indicated by a dark-shaded cross.", fig.show='hold'}
