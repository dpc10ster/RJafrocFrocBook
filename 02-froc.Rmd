...
```{r froc-paradigm-4, echo=FALSE, out.width="300pt", fig.align='center', fig.cap="Observer performance paradigms in current usage. The arrows point to two lesions and the light-shaded crosses indicate suspicious regions. Marked suspicious regions are indicated by dark-shaded crosses.", fig.show='hold'}
