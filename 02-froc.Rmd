...
```{r froc-paradigm-4, echo=FALSE, out.width="300pt", fig.align='center', fig.cap="Observer performance paradigms in use: Upper Left -- ROC, Upper Right -- FROC, Lower Left -- LROC, Lower Right -- ROI", fig.show='hold'}
