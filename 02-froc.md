...
<img src="images/4Paradigms.png" alt="Schematic showing the four observer performance paradigms. Arrows point to two lesions and light-shaded crosses indicate suspicious regions. Marked suspicious regions are indicated by dark-shaded crosses." width="300pt" />
<p class="caption">(\#fig:froc-paradigm-4)Schematic showing the four observer performance paradigms. Arrows point to two lesions and light-shaded crosses indicate suspicious regions. Marked suspicious regions are indicated by dark-shaded crosses.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="02-froc_files/figure-html/froc-paradigm-5-1.png" alt="Empirical FROC plot for `dataset04`, treatment 1 and reader 1." width="672" />
<p class="caption">(\#fig:froc-paradigm-5)Empirical FROC plot for `dataset04`, treatment 1 and reader 1.</p>
</div>
