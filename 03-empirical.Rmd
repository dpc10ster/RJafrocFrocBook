...
## Instructive cases {#empirical-instructive-cases}
...
The above formula is equivalent to creating two arrays, the first containing all finite NL ratings and the second containing all lesion ratings (including unmarked lesions). One compares, using the $\psi$ function, the ratings in the two arrays and divides by the total number of cases and by the total number of lesions. 
