...
frocNotation[12,]  <- c("12", "$\\zeta_r$", "$r$ = 2, 3, ..., non-dummy reporting thresholds")
frocNotation[13,]  <- c("13", "$\\zeta_0, \\zeta_{R_{FROC}+1}$", "Dummy thresholds, negative and positive infinity")
