...
```{r visual-search-kundel-nodine, out.width="300pt", fig.align = "center", echo=FALSE, fig.cap="The Kundel-Nodine model of radiological search. The glancing stage corresponds to search in my terminology while scanning corresponds to feature analysis."}
