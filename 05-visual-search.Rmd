...
```{r visual-search-us-presidents, out.width="300pt", fig.align = "center", echo=FALSE, fig.cap="Grouping and labeling ROIs"}
...
```{r visual-search-eye-tracking, out.width="300pt", fig.align = "center", echo=FALSE, fig.cap="Eye-tracking recordings for a two-view digital mammogram."}
