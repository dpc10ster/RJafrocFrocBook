...
## Search vs. detection {#visual-search-recognition-detection}
...
<div class="figure" style="text-align: center">
<img src="images/15-visual-search/kundel-nodine.png" alt="The Kundel-Nodine model of radiological search. The glancing stage corresponds to search in my terminology while scanning corresponds to feature analysis." width="300pt" />
<p class="caption">(\#fig:visual-search-kundel-nodine)The Kundel-Nodine model of radiological search. The glancing stage corresponds to search in my terminology while scanning corresponds to feature analysis.</p>
</div>
