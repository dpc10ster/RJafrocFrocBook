...
```{r rsm-pred-help, echo=FALSE,fig.cap="Help page for `RJafroc` function `UtilAnalyticalAucsRSM`.",fig.show='hold',fig.align='center'}
...
```{r rsm-pred-binorml-help, echo=FALSE,fig.cap="Help page for `RJafroc` function `UtilAucBinormal`.",fig.show='hold',fig.align='center'}
...
```{r rsm-pred-operating-characteristics-help, echo=FALSE,fig.cap="Help page for `RJafroc` function `PlotRsmOperatingCharacteristics`.",fig.show='hold',fig.align='center'}
