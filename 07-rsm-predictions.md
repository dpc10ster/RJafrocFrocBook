...
<div class="figure">
<img src="07-rsm-predictions_files/figure-html/rsm-predictions-fig-pdf-mu-plots-1.png" alt="RSM pdf curves for indicated values of the $\mu$ parameter. The solid curve corresponds to diseased cases and the dotted curve corresponds to non-diseased cases." width="672" />
...
<div class="figure">
<img src="07-rsm-predictions_files/figure-html/rsm-predictions-roc-zeta1-1.png" alt="ROC curves for two values of $\zeta$: both curves correspond to $\mu = 2$, $\nu = 1$ and $\lambda = 1$. The red curve corresponds to $\zeta = -10$ and the blue curve to $\zeta = 1$." width="672" />
...
<div class="figure">
<img src="07-rsm-predictions_files/figure-html/rsm-predictions-roc-plot-1.png" alt="ROC curve for selected RSM parameters. The slope of the dashed line is 0.4935272. " width="672" />
