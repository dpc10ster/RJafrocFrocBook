...
To extend the results to varying numbers of lesions per diseased case, one averages the right hand side of \@ref(eq:rsm-pred-tpf) over the fraction of diseased cases with $L$ lesions:
...
<p class="caption">(\#fig:rsm-pred-binorml-help)Help page for `RJafroc` function `UtilAucBormal`.</p>
</div>
