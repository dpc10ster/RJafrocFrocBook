...
```{r rsm-predictions-help, out.width="300pt", fig.align = "center", echo=FALSE, fig.cap="Help page for `RJafroc` function `UtilAnalyticalAucsRSM`."}
...
myLocalPrint <- function(index, mu, lambda, nu, zeta, lesDistr)
{
  if (index == 1) {
    cat("mu =", mu, 
        ", RSM-x =", sprintf("%6.4f", RSM_FPF(zeta,lambda)),
        ", RSM-y =", sprintf("%6.4f", RSM_TPF(zeta,mu,lambda,nu, lesDistr = lesDistr)), 
        "\n")
  }
...
cat("lesDistr = ", lesDistr, "\n")
cat("Varying mu only: \nOther parameters are lambda = ", lambda, ", nu = ", nu, ", zeta = ", zeta, "\n\n")
...
cat("lesDistr = ", lesDistr, "\n")
cat("Varying lambda only: \nOther parameters are mu = ", mu, ", nu = ", nu, ", zeta = ", zeta, "\n\n")
...
cat("lesDistr = ", lesDistr, "\n")
cat("Varying nu only: \nOther parameters are mu = ", mu, ", lambda = ", lambda, ", zeta = ", zeta, "\n\n")
...
cat("lesDistr = ", lesDistr, "\n")
cat("Varying zeta only: \nOther parameters are mu = ", mu, ", lambda = ", lambda, ", nu = ", nu, "\n\n")
...
cat("lesDistr = ", "(f, 1-f)", "\n")
cat("Varying f only: \nOther parameters are mu = ", mu, ", lambda = ", lambda, ", nu = ", nu, ", zeta = ", zeta, "\n\n")
for (f in seq(1,0,-0.1)) {
cat("f = ", f, 
    ", RSM-x = ", sprintf("%6.4f", RSM_FPF(zeta,lambda)),
    ", RSM-y = ", sprintf("%6.4f", RSM_TPF(zeta,mu,lambda,nu, lesDistr = c(f, 1-f))), 
    "\n")
}
```
...
```{r rsm-predictions-fig-auc-mu-plots, fig.cap="ROC curves for indicated values of the $\\mu$ parameter. Notice the transition, as $\\mu$ increases, from near chance level performance to almost perfect performancea as the end-point moves from near (1,1) to near (0,1).", fig.show='hold', echo=FALSE}
...
```{r rsm-predictions-fig-pdf-mu-plots, fig.cap="RSM pdf curves for indicated values of the $\\mu$ parameter. The solid curve corresponds to diseased cases and the dotted curve corresponds to non-diseased cases.", fig.show='hold', echo=FALSE}
grid.arrange(plotArr[[1]],plotArr[[2]],plotArr[[3]],plotArr[[4]], ncol = 2)
```
...
```{r rsm-predictions-binorml-help, out.width="300pt", fig.align = "center", echo=FALSE, fig.cap="Help page for `RJafroc` function `UtilAucBormal`."}
knitr::include_graphics("images/rsm-predictions/util-aucs-binormal.png")
``` 
...
```{r rsm-predictions-operating-characteristics-help, out.width="300pt", fig.align = "center", echo=FALSE, fig.cap="Help page for `RJafroc` function `PlotRsmOperatingCharacteristics`."}
knitr::include_graphics("images/rsm-predictions/PlotRsmOperatingCharacteristics.png")
``` 
...
```{r rsm-predictions-roc-plot, fig.cap="ROC curve for selected RSM parameters. The slope of the dashed line is 0.4935272. ", fig.show='hold', echo=FALSE, fig.pos='H'}
...
```{r rsm-predictions-plots1, fig.cap= "Horizontal dashed red line: the value of `mStLine`, the slope of the straight line connecting the ROC end-point to (1,1). Dashed blue line: slope using double precision arithmetic. Solid black line: slope using multiple precision arithmetic - this curve approaches the limiting value `mStLine`.", fig.show='hold'}
