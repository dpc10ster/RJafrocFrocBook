...
Like the ROC it has the constrained end-point property (the end-point lies within the unit square). This makes it easy, using the AFROC-AUC, to defined a valid figure of merit. 
