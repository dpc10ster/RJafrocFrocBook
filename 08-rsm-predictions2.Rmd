...
Use of a parametric model allows greater scrutiny of the predictions, for example the limiting slopes of the plots at the origin and the end-point, which is impossible using empirical plots.
