...
* TBA This is incorrect. The RSM fitted curve is in black. It is the only one with a dotted line connecting the uppermost continuously accessible operating point to (1,1).
...
The following example displays the composite plots for the Van Dyke dataset, treatment 2 and reader 2:
