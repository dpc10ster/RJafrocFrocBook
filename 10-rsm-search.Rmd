...
The preceding two chapters described the ROC and other predictions of the radiological search model (RSM). This chapter describes two key performance metrics, *search and lesion-classification performances*, that can be derived from the end-point of the predicted ROC curve. We start by recapitulating the formulae for the location of the RSM-predicted end-point. 
