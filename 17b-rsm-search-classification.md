...
<div class="figure">
<img src="17b-rsm-search-classification_files/figure-html/rsm-sc-performance-from-roc-curve-1.png" alt="Relation of search performance to the end-point of the ROC curve." width="672" />
<p class="caption">(\#fig:rsm-sc-performance-from-roc-curve)Relation of search performance to the end-point of the ROC curve.</p>
</div>
...
Using geometry and Eqn. \@ref(eq:rsm-sc-FPF-TPF-max), it follows that: 
...
### Lesion-classification performance and the 2AFC LKE task  {#rsm-sc-search-classification-2afc-lke}
