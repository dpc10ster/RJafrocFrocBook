...
The following code shows usage of the software to generate the results. Note that `RJafroc::datasetCadLroc` is the LROC dataset and `dataset09` is the corresponding ROC dataset. 
