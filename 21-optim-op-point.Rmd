...
* $\zeta_{1;1\mu \lambda \nu}$, the optimal thresholds for wAFROC optimizations and $\zeta_{1;2\mu \lambda \nu}$ for Youden-index optimizations;
* $\text{wAFROC} \left (1\mu \lambda \nu \right )$, the optimal value of the wAFROC-AUC for wAFROC optimizations; 
* $\text{wAFROC} \left (2\mu \lambda \nu \right )$, the optimal value of the wAFROC-AUC for Youden-index optimizations. For consistency we always report wAFROC-AUC even when the optimized quantity is the Youden-index;
* $\text{ROC} \left (1\mu \lambda \nu \right )$, the AUCs under the ROC curves for wAFROC optimizations;   
* $\text{ROC} \left (2\mu \lambda \nu \right )$, the AUCs under the ROC curves for Youden-index optimizations;   
* $\text{NLF} \left (1\mu \lambda \nu \right )$ and $\text{LLF} \left (1\mu \lambda \nu \right )$: the coordinates of the optimal operating points on the FROC curve for wAFROC optimizations;   
* $\text{NLF} \left (2\mu \lambda \nu \right )$ and $\text{LLF} \left (2\mu \lambda \nu \right )$: the coordinates of the optimal operating points on the FROC curve for Youden-index optimizations.   
