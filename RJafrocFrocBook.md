...
\begin{figure}
\includegraphics[width=1\linewidth]{images/4Paradigms} \caption{Upper Left: ROC, Upper Right: FROC, Lower Left: LROC, Lower Right: ROI}(\#fig:froc-paradigm-4)
\end{figure}
...
Operating characteristics are visual depicters of performance. Scalar quantities, typically area measures, derived from operating characteristics can serve as quantitative measures of performance, termed *figures of merit* (FOMs). This chapter defines the AUC associated with each introduced operating characteristic.
...
\caption{(\#tab:froc-empirical-notation)FROC notation; all marks refer to latent marks.}
\centering
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-1-1.pdf)<!-- --> 
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-4-1.pdf)<!-- --> 
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-10-1.pdf)<!-- --> 
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-13-1.pdf)<!-- --> 
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-16-1.pdf)<!-- --> 
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-19-1.pdf)<!-- --> 
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-20-1.pdf)<!-- --> 
...
![](13a-froc-empirical1_files/figure-latex/unnamed-chunk-21-1.pdf)<!-- --> 
...
<!--chapter:end:13a-froc-empirical1.Rmd-->
...
\caption{This image consists of 8 sub-images or ROIs. Understanding an image involves grouping and assigning labels to different ROIs, where the labels correspond to entities that exist in the real world. One familiar with US history would label them, from left to right and top to bottom, in raster fashion, Franklin Roosevelt, Harry Truman, Lyndon Johnson, Richard Nixon, Jimmy Carter, Ronald Reagan, George H. Bush and the presidential seal. Labeling accuracy depends on expertise of the observer. The row and column index of each ROI identifies its location.}(\#fig:visual-search-us-presidents)
\end{figure}
...
\caption{The Kundel-Nodine model of radiological search. The glancing/global stage identifies perturbations from the template of a generic non-diseased case. The scanning stage analyzes the each perturbation and calculates the probability it is a true lesion. Only perturbations with sufficiently high probability are marked.}(\#fig:visual-search-kundel-nodine)
\end{figure}
...
\caption{Eye-tracking recordings for a two-view digital mammogram: see details.}(\#fig:visual-search-eye-tracking)
\end{figure}
...
<!--chapter:end:15-visual-search.Rmd-->
...
\caption{Help page for `RJafroc` function `UtilAnalyticalAucsRSM`.}(\#fig:rsm-pred-help)
\end{figure}
...
\caption{Help page for `RJafroc` function `UtilAucBinormal`.}(\#fig:rsm-pred-binorml-help)
\end{figure}
...
\caption{Help page for `RJafroc` function `PlotRsmOperatingCharacteristics`.}(\#fig:rsm-pred-operating-characteristics-help)
\end{figure}
...
![(\#fig:rsm-pred-roc-zeta1)ROC curves for two values of $\zeta_1$: both curves correspond to $\mu = 2$, $\nu = 1$ and $\lambda = 1$. The red curve corresponds to $\zeta_1 = -10$ and the blue curve to $\zeta_1 = 1$.](17a-rsm-predictions_files/figure-latex/rsm-pred-roc-zeta1-1.pdf) 
...
![(\#fig:rsm-pred-fig-auc-mu-plots)ROC curves for indicated values of the $\mu$ parameter. Notice the transition, as $\mu$ increases, from near chance level performance to almost perfect performancea as the end-point moves from near (1,1) to near (0,1).](17a-rsm-predictions_files/figure-latex/rsm-pred-fig-auc-mu-plots-1.pdf) 
...
![(\#fig:rsm-pred-fig-pdf-mu-plots)RSM pdf curves for indicated values of the $\mu$ parameter. The solid curve corresponds to diseased cases and the dotted curve corresponds to non-diseased cases.](17a-rsm-predictions_files/figure-latex/rsm-pred-fig-pdf-mu-plots-1.pdf) 
...
![(\#fig:rsm-pred-roc-plot)ROC curve for selected RSM parameters. The slope of the dashed line is 0.4935272. ](17a-rsm-predictions_files/figure-latex/rsm-pred-roc-plot-1.pdf) 
...
![(\#fig:rsm-pred-plots1)Horizontal dashed red line: the value of `mStLine`, the slope of the straight line connecting the ROC end-point to (1,1). Dashed blue line: slope using double precision arithmetic. Solid black line: slope using multiple precision arithmetic - this curve approaches the limiting value `mStLine`.](17a-rsm-predictions_files/figure-latex/rsm-pred-plots1-1.pdf) 
...
<!--chapter:end:17a-rsm-predictions.Rmd-->
...
![(\#fig:froc-afroc-roc-raw-seed1)Raw FROC, AFROC and ROC plots with seed = 1: Plots A, B, C are for $K_1 = 5$ and $K_2 = 7$ cases while plots D, E, F are for $K_1 = 50$ and $K_2 = 70$ cases.](13b-froc-empirical2_files/figure-latex/froc-afroc-roc-raw-seed1-1.pdf) 
...
![(\#fig:froc-afroc-roc-raw-seed2)Raw FROC, AFROC and ROC plots with seed = 2: Plots A, B, C are for $K_1 = 5$ and $K_2 = 7$ cases while plots D, E, F are for $K_1 = 50$ and $K_2 = 70$ cases.](13b-froc-empirical2_files/figure-latex/froc-afroc-roc-raw-seed2-1.pdf) 
...
![(\#fig:froc-afroc-chance-level)Plot A is the near guessing observer's FROC and plot B is the corresponding AFROC for $\mu=0.01$.](13b-froc-empirical2_files/figure-latex/froc-afroc-chance-level-1.pdf) 
...
![(\#fig:froc-afroc-roc-binned-seed1)Binned FROC, AFROC and ROC plots with seed = 1: Plots A, B, C are for $K_1 = 5$ and $K_2 = 7$ cases while plots D, E, F are for $K_1 = 50$ and $K_2 = 70$ cases](13b-froc-empirical2_files/figure-latex/froc-afroc-roc-binned-seed1-1.pdf) 
...
![(\#fig:froc-afroc-roc-binned-seed2)Binned FROC, AFROC and ROC plots with seed = 2: Plots A, B, C are for $K_1 = 5$ and $K_2 = 7$ cases while plots D, E, F are for $K_1 = 50$ and $K_2 = 70$ cases](13b-froc-empirical2_files/figure-latex/froc-afroc-roc-binned-seed2-1.pdf) 
...
<!--chapter:end:13b-froc-empirical2.Rmd-->
...
![(\#fig:froc-vs-wafroc-plot1)Plots A and D: FROC curves for the R1 and R2 observers; B and E are corresponding wAFROC curves and C and F are corresponding ROC curves. All curves in this plot are for $\lambda = \nu = 1$. All RAD_1 curves are for $\mu = 1$ and all RAD_2 curves are for $\mu = 1.5$. For panels A, B and C, $\zeta_1 = -1$ for R1 and $\zeta_1 = 1.5$ for R2. For panels D, E and F, $\zeta_1 = -\infty$ for R1 and R2.](13c-froc-vs-wafroc_files/figure-latex/froc-vs-wafroc-plot1-1.pdf) 
...
![(\#fig:froc-vs-wafroc-plot2)Similar to preceding figure but with the following changes. All RAD_2 curves are for $\mu = 2$ and for panels A, B and C $\zeta_1 = 2$ for R2.](13c-froc-vs-wafroc_files/figure-latex/froc-vs-wafroc-plot2-1.pdf) 
...
![(\#fig:froc-vs-wafroc-plot3)Similar to preceding figure but with the following changes. All RAD_2 curves are for $\mu = 1.1$ and for panels A, B and C, $\zeta_1 = -1$ for R2.](13c-froc-vs-wafroc_files/figure-latex/froc-vs-wafroc-plot3-1.pdf) 
...
\caption{(\#tab:froc-vs-wafroc-summary-table-rdr1)Summary of R1 simulations: A refers to panel A, B refers to panel B, etc.}
\centering
...
\caption{(\#tab:froc-vs-wafroc-summary-table-rdr2)Summary of R2 simulations: Fig refers to the figure number in this chapter, A refers to panel A, B refers to panel B, etc.}
\centering
...
\caption{(\#tab:froc-vs-wafroc-effect-size-rdr2)Effect size comparions for R1 simulations: Fig refers to the figure number in this chapter.}
\centering
\begin{tabular}[t]{l|l|l}
\hline
...
<!--chapter:end:13c-froc-vs-wafroc.Rmd-->
...
![(\#fig:rsm-sc-performance-from-roc-curve)Relation of search performance to the end-point of the ROC curve.](17b-rsm-search-classification_files/figure-latex/rsm-sc-performance-from-roc-curve-1.pdf) 
...
<!--chapter:end:17b-rsm-search-classification.Rmd-->
...
<!--chapter:end:17d-rsm-goodbye-froc.Rmd-->
...
\caption{A typical 4-view display of a patient mammogram with the CAD cues (the red arrows) turned on.}(\#fig:rsm-fitting-fig1)
\end{figure}
...
\caption{The IDCA method of fitting designer-level CAD FROC data.}(\#fig:rsm-fitting-fig2)
\end{figure}
...
![](19a-rsm-fitting_files/figure-latex/unnamed-chunk-2-1.pdf)<!-- --> 
...
<!--chapter:end:19a-rsm-fitting.Rmd-->
...
![](19b-rsm-3-fits_files/figure-latex/unnamed-chunk-2-1.pdf)<!-- --> 
...
![](19b-rsm-3-fits_files/figure-latex/unnamed-chunk-3-1.pdf)<!-- --> 
...
![(\#fig:rsm-3-fits-plots-2)Van Dyke dataset: Left plot is PROPROC-AUC vs. RSM-AUC with the superposed constrained linear fit. The number of data points is `nPts` = 10. Right plot is CBM-AUC vs. RSM-AUC.](19b-rsm-3-fits_files/figure-latex/rsm-3-fits-plots-2-1.pdf) 


The next plot shows corresponding plots for the Franken dataset.


![(\#fig:rsm-3-fits-plots-3)Similar to previous plot, for Franken dataset.](19b-rsm-3-fits_files/figure-latex/rsm-3-fits-plots-3-1.pdf) 
...
![(\#fig:rsm-3-fits-histo-slopes)Histograms of slope PROPROC AUC vs. RSM AUC (left) and slope CBM AUC vs. RSM AUC (right).](19b-rsm-3-fits_files/figure-latex/rsm-3-fits-histo-slopes-1.pdf) 
...
\caption{(\#tab:rsm-3-fits-slopes-table1)Summary of slopes and correlations for the two constrained fits: PROPROC AUC vs. RSM AUC and CBM AUC vs. RSM AUC. The average of each slope equals unity to within 0.6 percent.}
\centering
\resizebox{\linewidth}{!}{
...
\caption{Partial screen shot of `RJafroc` help file showing the datasets included with the current distribution (v2.0.1).}(\#fig:rsm-3-fits-datasets)
\end{figure}
...
\caption{Screen shot (1 of 2) of `R/compare-3-fits/MRMCRuns` showing the folders containing the results of PROPROC analysis on 14 datasets.}(\#fig:rsm-3-fits-mrmc-runs)
\end{figure}
...
\caption{Screen shot (2 of 2) of `R/compare-3-fits/MRMCRuns/VD` showing files containing the results of PROPROC analysis for the Van Dyke dataset.}(\#fig:rsm-3-fits-mrmc-runs-vd)
\end{figure}
...
\caption{PROPROC output for the Van Dyke ROC data set.}(\#fig:rsm-3-fits-proproc-output-van-dyke)
\end{figure}
...
\caption{Screen shot of `R/compare-3-fits/RSM6` showing the results files created by  `Compare3ProperRocFits()` .}(\#fig:rsm-3-fits-all-results-rsm6)
\end{figure}
...
![(\#fig:rsm-3-fits-plots-1-1)Composite plots in both treatments for Van Dyke dataset, reader 1.](19b-rsm-3-fits_files/figure-latex/rsm-3-fits-plots-1-1-1.pdf) 


![(\#fig:rsm-3-fits-plots-1-2)Composite plots in both treatments for Van Dyke dataset, reader 2. For treatment 2 the RSM and PROPROC fits are indistinguishable.](19b-rsm-3-fits_files/figure-latex/rsm-3-fits-plots-1-2-1.pdf) 
...
![(\#fig:rsm-3-fits-plots-1-3)Composite plots in both treatments for Van Dyke dataset, reader 3.](19b-rsm-3-fits_files/figure-latex/rsm-3-fits-plots-1-3-1.pdf) 
...
![(\#fig:rsm-3-fits-plots-1-4)Composite plots in both treatments for Van Dyke dataset, reader 4. For treatment 2 the 3 plots are indistinguishable and each one has AUC = 1. The degeneracy is due to all operating points being on the axes of the unit square.](19b-rsm-3-fits_files/figure-latex/rsm-3-fits-plots-1-4-1.pdf) 


![(\#fig:rsm-3-fits-plots-1-5)Composite plots in both treatments for Van Dyke dataset, reader 5.](19b-rsm-3-fits_files/figure-latex/rsm-3-fits-plots-1-5-1.pdf) 
...
<!--chapter:end:19b-rsm-3-fits.Rmd-->
...
<!--chapter:end:20-standalone-cad.Rmd-->
...
![(\#fig:optim-op-point-vary-lambda)Left panel: maximized wAFROC AUC was used to find optimal $\zeta_1$. Right panel: maximized Youden-index was used to find optimal $\zeta_1$. Dot colors: black means $\lambda = 1$, red means $\lambda = 5$, green means $\lambda = 10$ and blue means $\lambda = 15$.](21-optim-op-point_files/figure-latex/optim-op-point-vary-lambda-1.pdf) 
...
![(\#fig:optim-op-point-vary-lambda-wafroc)wAFROC curves for wAFROC-AUC and Youden-index based optimizations: both curves correspond to $\mu = 2$, $\nu = 1$ and $\lambda = 1$. The optimal reporting theshold $\zeta_1$ is determined by the selected FOM. The red curve corresponds to FOM = wAFROC-AUC and the blue curve corresponds to FOM = Youden-index. The stricter reporting threshold found by the Youden-index based method sacrifices a considerable amount of area under the wAFROC.  The two wAFROC-AUCs are 0.880 and 0.856, respectively.](21-optim-op-point_files/figure-latex/optim-op-point-vary-lambda-wafroc-1.pdf) 
...
![(\#fig:optim-op-point-vary-nu)Left panel: maximized wAFROC-AUC was used to find optimal $\zeta_1$. Right panel: maximized Youden-index was used to find optimal $\zeta_1$. Dot colors: black means $\nu = 0.1$, red means $\nu = 0.5$, green means $\nu = 1$ and blue means $\nu = 2$.](21-optim-op-point_files/figure-latex/optim-op-point-vary-nu-1.pdf) 
...
![(\#fig:optim-op-point-vary-nu-wafroc)wAFROC curves for wAFROC-AUC and Youden-index based optimizations: both curves correspond to $\mu = 2$, $\lambda = 5$ and $\nu = 2$. The optimal reporting theshold $\zeta_1$ is determined by the selected FOM. The red curve corresponds to FOM = wAFROC-AUC and the blue curve corresponds to FOM = Youden-index. The stricter reporting threshold found by the Youden-index based method sacrifices a considerable amount of area under the wAFROC.  The two wAFROC-AUCs are 0.841 and 0.793, respectively.](21-optim-op-point_files/figure-latex/optim-op-point-vary-nu-wafroc-1.pdf) 
...
![(\#fig:optim-op-point-vary-mu)Left panel: maximized wAFROC-AUC was used to find optimal $\zeta_1$. Right panel: maximized Youden-index was used to find optimal $\zeta_1$. Dot colors: black means $\mu = 0.75$, red means $\mu = 1$, green means $\lambda = 1.25$ and blue means $\mu = 1.5$.](21-optim-op-point_files/figure-latex/optim-op-point-vary-mu-1.pdf) 
...
![(\#fig:optim-op-point-vary-mu-wafroc)wAFROC curves for wAFROC-AUC and Youden-index based optimizations: both curves correspond to $\lambda = 1$, $\nu = 1$ and $\mu = 1.5$. The optimal reporting theshold $\zeta_1$ is determined by the selected FOM. The red curve corresponds to FOM = wAFROC-AUC and the blue curve corresponds to FOM = Youden-index. The stricter reporting threshold found by the Youden-index based method sacrifices a considerable amount of area under the wAFROC. The two wAFROC-AUCs are 0.777 and 0.760, respectively.](21-optim-op-point_files/figure-latex/optim-op-point-vary-mu-wafroc-1.pdf) 
...
\caption{(\#tab:optim-op-point-table4)Summary of optimization results for example FROC dataset. The wAFROC column always displays wAFROC-AUC, even though the optimized quantity may the Youden-index, as in the last four rows.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{llllll}
\toprule
...
![(\#fig:optim-op-point-application-froc)Left panel: maximized wAFROC-AUC was used to find optimal $\zeta_1$. Right panel: maximized Youden-index was used.](21-optim-op-point_files/figure-latex/optim-op-point-application-froc-1.pdf) 





![(\#fig:optim-op-point-application-wafroc)Red line and dots: wAFROC-AUC based optimization; blue line and dots: Youden-index based optimization. The two wAFROC-AUCs are 0.774 and 0.770, respectively.](21-optim-op-point_files/figure-latex/optim-op-point-application-wafroc-1.pdf) 
...
<!--chapter:end:21-optim-op-point.Rmd-->
