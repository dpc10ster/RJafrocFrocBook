...
\end{aligned}
\right \}
\label{eq:rsm-other-predictions-froc-end-point}
\end{equation}

The end-point is not constrained to lie within the unit-square, rather it is \emph{semi-constrained}: while the maximum ordinate \(\nu\) cannot exceed unity the maximum abscissa \(\lambda\) can.
...
\caption{\label{fig:rsm-other-predictions-froc-plots-lambdai-nui}RSM-predicted FROC curves using intrinsic parameters \(\lambda_i = 2\) and \(\nu_i = 0.5\). Top left: \(\mu = 0.1\); Top right: \(\mu = 1\); Bottom left: \(\mu = 2\); Bottom right: \(\mu = 4\). Each plot is \textbf{not} contained within the unit square which makes it impossible to define the FROC-AUC as a figure of merit.}
\end{figure}
...
The AFROC x-coordinate is the same as the ROC x-coordinate and Eqn. \eqref{eq:rsm-pred-fpf} applies. The AFROC y-coordinate is identical to the FROC y-coordinate and Eqn. \eqref{eq:rsm-other-predictions-llf} applies. Therefore:
...
\hypertarget{rsm-other-predictions-discussion-summary}{%
\section{Discussion / Summary}\label{rsm-other-predictions-discussion-summary}}
...
If instead we had used Eqn. \eqref{eq:rsm-other-predictions-froc-slope2} and regarded \(\lambda\) and \(\nu\) as independent of \(\mu\), the last conclusion would change to:
...
\end{aligned}
\right \}
\label{eq:rsm-pred-roc-above-afroc}
\end{equation}
...
\subsection{wAFROC curves above AFROC curves?}\label{rsm-other-predictions-wafroc-above-afroc}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{relWeights =}\StringTok{  }\KeywordTok{c}\NormalTok{(}\FloatTok{0.01}\NormalTok{, }\FloatTok{0.04}\NormalTok{, }\FloatTok{0.05}\NormalTok{, }\FloatTok{0.9}\NormalTok{)}
\NormalTok{lesDistr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.7}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (nu }\ControlFlowTok{in} \KeywordTok{seq}\NormalTok{(}\FloatTok{0.1}\NormalTok{,}\FloatTok{0.9}\NormalTok{,}\FloatTok{0.1}\NormalTok{)) }
  \KeywordTok{computeDiff}\NormalTok{(nu, lesDistr, relWeights)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{relWeights =}\StringTok{  }\KeywordTok{c}\NormalTok{(}\FloatTok{0.9}\NormalTok{, }\FloatTok{0.04}\NormalTok{, }\FloatTok{0.05}\NormalTok{, }\FloatTok{0.01}\NormalTok{)}
\NormalTok{lesDistr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.1}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.7}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (nu }\ControlFlowTok{in} \KeywordTok{seq}\NormalTok{(}\FloatTok{0.1}\NormalTok{,}\FloatTok{0.9}\NormalTok{,}\FloatTok{0.1}\NormalTok{)) }
  \KeywordTok{computeDiff}\NormalTok{(nu, lesDistr, relWeights)}
\end{Highlighting}
...
\begin{Highlighting}[]
\NormalTok{relWeights =}\StringTok{  }\KeywordTok{c}\NormalTok{(}\FloatTok{0.9}\NormalTok{, }\FloatTok{0.04}\NormalTok{, }\FloatTok{0.05}\NormalTok{, }\FloatTok{0.01}\NormalTok{)}
\NormalTok{lesDistr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.7}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.1}\NormalTok{, }\FloatTok{0.1}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (nu }\ControlFlowTok{in} \KeywordTok{seq}\NormalTok{(}\FloatTok{0.1}\NormalTok{,}\FloatTok{0.9}\NormalTok{,}\FloatTok{0.1}\NormalTok{)) }
  \KeywordTok{computeDiff}\NormalTok{(nu, lesDistr, relWeights)}
\end{Highlighting}
\end{Shaded}
