...
\NormalTok{dsNoNormals}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr <-}\StringTok{ }
\StringTok{  }\NormalTok{dsNoNormals}\OperatorTok{$}\NormalTok{descriptions}\OperatorTok{$}\NormalTok{truthTableStr[,,}\OperatorTok{-}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\NormalTok{K1),]}
...
\NormalTok{st <-}\StringTok{ }\KeywordTok{StSignificanceTesting}\NormalTok{(dsTony,}\DataTypeTok{FOM =} \StringTok{"wAFROC"}\NormalTok{)}
\NormalTok{st1 <-}\StringTok{ }\KeywordTok{StSignificanceTesting}\NormalTok{(dsNoNormals,}\DataTypeTok{FOM =} \StringTok{"wAFROC1"}\NormalTok{)}
\NormalTok{st}\OperatorTok{$}\NormalTok{RRRC}
\CommentTok{#> $FTests}
\CommentTok{#>                  DF         MS     FStat            p}
\CommentTok{#> Treatment  1.000000 4.72951648 10.298825 0.0036685784}
\CommentTok{#> Error     24.702758 0.45922873        NA           NA}
\CommentTok{#> }
\CommentTok{#> $ciDiffTrt}
\CommentTok{#>              Estimate      StdErr        DF         t        PrGTt     CILower}
\CommentTok{#> trtBT-trtDM 0.1011236 0.031510744 24.702758 3.2091783 0.0036685784 0.036186385}
\CommentTok{#>                CIUpper}
\CommentTok{#> trtBT-trtDM 0.16606081}
\CommentTok{#> }
\CommentTok{#> $ciAvgRdrEachTrt}
\CommentTok{#>         Estimate      StdErr        DF    CILower    CIUpper}
\CommentTok{#> trtBT 0.81223666 0.026984337 59.281486 0.75824649 0.86622683}
\CommentTok{#> trtDM 0.71111306 0.033910209 17.789298 0.63980982 0.78241630}
\NormalTok{st1}\OperatorTok{$}\NormalTok{RRRC}
\CommentTok{#> $FTests}
\CommentTok{#>                  DF          MS     FStat            p}
\CommentTok{#> Treatment   1.00000 0.583686978 7.9579613 0.0051936318}
\CommentTok{#> Error     236.88206 0.073346295        NA           NA}
\CommentTok{#> }
\CommentTok{#> $ciDiffTrt}
\CommentTok{#>                Estimate      StdErr        DF         t        PrGTt}
\CommentTok{#> trtBT-trtDM 0.051218281 0.018156163 236.88206 2.8209859 0.0051936318}
\CommentTok{#>                 CILower    CIUpper}
\CommentTok{#> trtBT-trtDM 0.015450111 0.08698645}
\CommentTok{#> }
\CommentTok{#> $ciAvgRdrEachTrt}
\CommentTok{#>         Estimate      StdErr        DF    CILower    CIUpper}
\CommentTok{#> trtBT 0.89511425 0.019745498 24.733020 0.85442537 0.93580314}
\CommentTok{#> trtDM 0.84389597 0.024970629 27.621445 0.79271436 0.89507759}
\end{Highlighting}
\end{Shaded}
