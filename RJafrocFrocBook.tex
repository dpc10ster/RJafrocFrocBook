...
\hypertarget{optim-op-point2}{%
\chapter{Optimal operating point}\label{optim-op-point2}}
...
\cmidrule{1-6}
 & 1 & 1.022 & 0.700 & 0.797 & (0.153, 0.502)\\
\cmidrule{2-6}
 & 1 & 1.044 & 0.745 & 0.835 & (0.148, 0.581)\\
\cmidrule{2-6}
 & 1 & 1.069 & 0.788 & 0.868 & (0.143, 0.659)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash Youden} & 1 & 1.095 & 0.831 & 0.899 & (0.137, 0.735)\\
\bottomrule
\end{tabular}}
\end{table}
...
\cmidrule{2-6}
 & 1 & 1.095 & 0.831 & 0.899 & (0.137, 0.735)\\
\cmidrule{2-6}
 & 1 & 1.629 & 0.903 & 0.945 & (0.052, 0.823)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash Youden} & 1 & 2.124 & 0.935 & 0.964 & (0.017, 0.873)\\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{muArr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{6}\NormalTok{)}
\NormalTok{nuPArr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.9}\NormalTok{)}
\NormalTok{lambdaPArr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{lesDistr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\FloatTok{0.5}\NormalTok{)}
\NormalTok{relWeights <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\FloatTok{0.5}\NormalTok{)}
...
\midrule
wAFROC & 3 & 1 & 0.9 & 0.808 & 0.922 & 0.961 & 0.811 & 0.949\\
Youden & 3 & 1 & 0.9 & 1.629 & 0.903 & 0.945 & 0.950 & 0.901\\
wAFROC & 4 & 1 & 0.9 & 1.463 & 0.942 & 0.970 & 0.931 & 0.946\\
Youden & 4 & 1 & 0.9 & 2.124 & 0.935 & 0.964 & 0.983 & 0.929\\
wAFROC & 5 & 1 & 0.9 & 2.063 & 0.948 & 0.972 & 0.981 & 0.945\\
\addlinespace
Youden & 5 & 1 & 0.9 & 2.608 & 0.946 & 0.970 & 0.995 & 0.941\\
wAFROC & 6 & 1 & 0.9 & 2.634 & 0.950 & 0.972 & 0.996 & 0.945\\
Youden & 6 & 1 & 0.9 & 3.093 & 0.949 & 0.972 & 0.999 & 0.944\\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point_files/figure-latex/optim-op-point-high-performance-vary-mu-vary-all-froc-1.pdf}
...
\caption{\label{tab:optim-op-point-low-performance-vary-mu-table-vary-all}Summary of optimizations for combinations of levels of $\mu$, $\lambda$ and $\nu$ parameters. FOM = figure of merit, $\zeta_1$ = threshold that optimizes FOM, wAFROC = wAFROC-AUC, ROC = ROC-AUC, Sp = specificity and Se = sensitivity.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrlllll}
\toprule
FOM & $\mu$ & $\lambda$ & $\nu$ & $\zeta_1$ & wAFROC & ROC & Sp & Se\\
\midrule
wAFROC & 1 & 10 & 0.1 & 5.000 & 0.500 & 0.500 & 1.000 & 0.000\\
Youden & 1 & 10 & 0.1 & 1.563 & 0.292 & 0.514 & 0.554 & 0.469\\
wAFROC & 2 & 10 & 0.1 & 3.298 & 0.502 & 0.507 & 0.995 & 0.019\\
Youden & 2 & 10 & 0.1 & 1.865 & 0.397 & 0.535 & 0.733 & 0.327\\
wAFROC & 3 & 10 & 0.1 & 3.018 & 0.518 & 0.536 & 0.987 & 0.084\\
\addlinespace
Youden & 3 & 10 & 0.1 & 2.198 & 0.478 & 0.555 & 0.869 & 0.231\\
wAFROC & 4 & 10 & 0.1 & 3.130 & 0.536 & 0.559 & 0.991 & 0.126\\
Youden & 4 & 10 & 0.1 & 2.564 & 0.523 & 0.567 & 0.950 & 0.178\\
\bottomrule
\end{tabular}}
\end{table}
...
wAFROC & 5 & 1 & 0.9 & 2.063 & 0.948 & 0.972 & 0.981 & 0.945\\
Youden & 5 & 1 & 0.9 & 2.608 & 0.946 & 0.970 & 0.995 & 0.941\\
wAFROC & 5 & 2 & 0.9 & 2.204 & 0.947 & 0.972 & 0.973 & 0.945\\
Youden & 5 & 2 & 0.9 & 2.746 & 0.944 & 0.969 & 0.994 & 0.939\\
wAFROC & 5 & 5 & 0.9 & 2.390 & 0.945 & 0.971 & 0.959 & 0.945\\
\addlinespace
Youden & 5 & 5 & 0.9 & 2.926 & 0.941 & 0.967 & 0.991 & 0.935\\
wAFROC & 5 & 10 & 0.9 & 2.533 & 0.943 & 0.970 & 0.945 & 0.945\\
Youden & 5 & 10 & 0.9 & 3.062 & 0.937 & 0.965 & 0.989 & 0.931\\
\bottomrule
\end{tabular}}
\end{table}
...
\caption{\label{tab:optim-op-point-low-performance-vary-lambda-table-vary-all}Summary of optimizations for combinations of levels of $\mu$, $\lambda$ and $\nu$ parameters. FOM = figure of merit, $\zeta_1$ = threshold that optimizes FOM, wAFROC = wAFROC-AUC, ROC = ROC-AUC, Sp = specificity and Se = sensitivity.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrlllll}
\toprule
FOM & $\mu$ & $\lambda$ & $\nu$ & $\zeta_1$ & wAFROC & ROC & Sp & Se\\
\midrule
wAFROC & 1 & 1 & 0.2 & 2.081 & 0.505 & 0.520 & 0.981 & 0.059\\
Youden & 1 & 1 & 0.2 & 0.284 & 0.423 & 0.587 & 0.678 & 0.469\\
wAFROC & 1 & 2 & 0.2 & 2.795 & 0.501 & 0.505 & 0.995 & 0.016\\
Youden & 1 & 2 & 0.2 & 0.734 & 0.380 & 0.566 & 0.629 & 0.480\\
wAFROC & 1 & 5 & 0.2 & 3.718 & 0.500 & 0.500 & 0.999 & 0.001\\
\addlinespace
Youden & 1 & 5 & 0.2 & 1.237 & 0.335 & 0.542 & 0.583 & 0.486\\
wAFROC & 1 & 10 & 0.2 & 4.412 & 0.500 & 0.500 & 1.000 & 0.000\\
Youden & 1 & 10 & 0.2 & 1.568 & 0.309 & 0.528 & 0.557 & 0.490\\
\bottomrule
\end{tabular}}
\end{table}
...
\NormalTok{lambdaPArr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{nuPArr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.3}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\FloatTok{0.7}\NormalTok{, }\FloatTok{0.9}\NormalTok{)}
\NormalTok{lesDistr <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\FloatTok{0.5}\NormalTok{)}
\NormalTok{relWeights <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\FloatTok{0.5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
FOM & $\mu$ & $\lambda$ & $\nu$ & $\zeta_1$ & wAFROC & ROC & Sp & Se\\
\midrule
wAFROC & 4 & 1 & 0.3 & 2.216 & 0.640 & 0.696 & 0.987 & 0.400\\
Youden & 4 & 1 & 0.3 & 2.023 & 0.639 & 0.698 & 0.979 & 0.409\\
wAFROC & 4 & 1 & 0.5 & 2.006 & 0.738 & 0.806 & 0.978 & 0.622\\
Youden & 4 & 1 & 0.5 & 2.047 & 0.738 & 0.806 & 0.980 & 0.620\\
wAFROC & 4 & 1 & 0.7 & 1.796 & 0.839 & 0.898 & 0.964 & 0.804\\
\addlinespace
Youden & 4 & 1 & 0.7 & 2.080 & 0.837 & 0.894 & 0.981 & 0.793\\
wAFROC & 4 & 1 & 0.9 & 1.463 & 0.942 & 0.970 & 0.931 & 0.946\\
Youden & 4 & 1 & 0.9 & 2.124 & 0.935 & 0.964 & 0.983 & 0.929\\
\bottomrule
\end{tabular}}
...
\caption{\label{tab:optim-op-point-low-performance-vary-nu-table-vary-all}Summary of optimizations for combinations of levels of $\mu$, $\lambda$ and $\nu$ parameters. FOM = figure of merit, $\zeta_1$ = threshold that optimizes FOM, wAFROC = wAFROC-AUC, ROC = ROC-AUC, Sp = specificity and Se = sensitivity.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrrrlllll}
\toprule
FOM & $\mu$ & $\lambda$ & $\nu$ & $\zeta_1$ & wAFROC & ROC & Sp & Se\\
\midrule
wAFROC & 1 & 10 & 0.3 & 4.006 & 0.500 & 0.500 & 1.000 & 0.001\\
Youden & 1 & 10 & 0.3 & 1.572 & 0.325 & 0.542 & 0.560 & 0.509\\
wAFROC & 1 & 10 & 0.5 & 3.493 & 0.500 & 0.502 & 0.998 & 0.007\\
Youden & 1 & 10 & 0.5 & 1.582 & 0.358 & 0.569 & 0.566 & 0.547\\
wAFROC & 1 & 10 & 0.7 & 3.148 & 0.501 & 0.508 & 0.992 & 0.025\\
\addlinespace
Youden & 1 & 10 & 0.7 & 1.591 & 0.389 & 0.594 & 0.572 & 0.583\\
wAFROC & 1 & 10 & 0.9 & 2.881 & 0.504 & 0.520 & 0.980 & 0.059\\
Youden & 1 & 10 & 0.9 & 1.601 & 0.420 & 0.619 & 0.579 & 0.618\\
\bottomrule
\end{tabular}}
\end{table}
...
\hypertarget{optim-op-point-references2}{%
\section{References}\label{optim-op-point-references2}}
