...
\NormalTok{  ret }\OtherTok{\textless{}{-}} \FunctionTok{UtilIntrinsic2RSM}\NormalTok{(mu, }\AttributeTok{lambda\_i =}\NormalTok{ lambda\_i, }\AttributeTok{nu\_i =}\NormalTok{ nu\_i)}
...
\FunctionTok{UtilLesionWeightsMatrixLesDistr}\NormalTok{(lesDistr, relWeights)[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{UtilLesionWeightsMatrixLesDistr}\NormalTok{(lesDistr, }\AttributeTok{relWeights =}\NormalTok{ relWeights0)[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ret }\OtherTok{\textless{}{-}} \FunctionTok{Compare3ProperRocFits}\NormalTok{(datasetNames, }\FunctionTok{which}\NormalTok{(datasetNames }\SpecialCharTok{==} \StringTok{"VD"}\NormalTok{))}
...
\NormalTok{ret }\OtherTok{\textless{}{-}} \FunctionTok{Compare3ProperRocFits}\NormalTok{(datasetNames, }\FunctionTok{which}\NormalTok{(datasetNames }\SpecialCharTok{==} \StringTok{"FR"}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{LesionLocLesionCls }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mu, lambda, nu, lesDistr) \{}
\NormalTok{  temp }\OtherTok{\textless{}{-}} \DecValTok{0}
  \ControlFlowTok{for}\NormalTok{ (L }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(lesDistr)) \{}
\NormalTok{    temp }\OtherTok{\textless{}{-}}\NormalTok{ temp }\SpecialCharTok{+}\NormalTok{ lesDistr[L] }\SpecialCharTok{*}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ nu)}\SpecialCharTok{\^{}}\NormalTok{L}
\NormalTok{  \}}
\NormalTok{  L\_L }\OtherTok{\textless{}{-}} \FunctionTok{exp}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{lambda) }\SpecialCharTok{*}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ temp)}
\NormalTok{  L\_C }\OtherTok{\textless{}{-}} \FunctionTok{pnorm}\NormalTok{(mu}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(}\DecValTok{2}\NormalTok{))}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
    \AttributeTok{L\_L =}\NormalTok{ L\_L,}
    \AttributeTok{L\_C =}\NormalTok{ L\_C}
\NormalTok{  ))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu }\OtherTok{\textless{}{-}}\NormalTok{ resultsVD[[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{mu}
\NormalTok{lambda }\OtherTok{\textless{}{-}}\NormalTok{ resultsVD[[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{lambda}
\NormalTok{nu }\OtherTok{\textless{}{-}}\NormalTok{ resultsVD[[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{nu}
\NormalTok{f }\OtherTok{\textless{}{-}} \FunctionTok{which}\NormalTok{(datasetNames }\SpecialCharTok{==} \StringTok{"VD"}\NormalTok{)}
\NormalTok{fileName }\OtherTok{\textless{}{-}}\NormalTok{ datasetNames[f]}
\NormalTok{theData }\OtherTok{\textless{}{-}} \FunctionTok{get}\NormalTok{(}\FunctionTok{sprintf}\NormalTok{(}\StringTok{"dataset\%02d"}\NormalTok{, f)) }\CommentTok{\# the datasets already exist as R objects}
\NormalTok{lesDistr }\OtherTok{\textless{}{-}} \FunctionTok{UtilLesionDistrVector}\NormalTok{(theData) }\CommentTok{\# RSM ROC fitting needs to know lesDistr}

\NormalTok{ret }\OtherTok{\textless{}{-}} \FunctionTok{LesionLocLesionCls}\NormalTok{(mu, lambda, nu, lesDistr)}
\NormalTok{L\_L }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{L\_L}
\NormalTok{L\_C }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{L\_C}
  
\FunctionTok{cat}\NormalTok{(}\FunctionTok{sprintf}\NormalTok{(}\StringTok{"VD data i=1 j=2:  L\_L = \%7.3f, L\_C = \%7.3f"}\NormalTok{, L\_L, L\_C), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{slopes }\OtherTok{\textless{}{-}} \FunctionTok{slopesConvVsRsm}\NormalTok{(datasetNames)}
