...
FOM & $\nu$ & $\zeta_1$ & $\text{wAFROC}$ & $\text{ROC}$ & $\left( \text{NLF}, \text{LLF}\right)$\\
\midrule
 & 0.3 & 2.216 & 0.640 & 0.696 & (0.013, 0.289)\\
\cmidrule{2-6}
 & 0.5 & 2.006 & 0.738 & 0.806 & (0.022, 0.488)\\
\cmidrule{2-6}
 & 0.7 & 1.796 & 0.839 & 0.898 & (0.036, 0.690)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash wAFROC} & 0.9 & 1.463 & 0.942 & 0.970 & (0.072, 0.895)\\
\cmidrule{1-6}
 & 0.3 & 2.023 & 0.639 & 0.698 & (0.022, 0.293)\\
\cmidrule{2-6}
 & 0.5 & 2.047 & 0.738 & 0.806 & (0.020, 0.487)\\
\cmidrule{2-6}
...
\caption{\label{tab:optim-op-point-low-performance-vary-nu-table-vary-all}Summary of optimization results for 4 values of $\mu$, $\lambda = 1$ and $nu = 0.9$. Row labeling as in previous tables.}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{llllll}
\toprule
...
\cmidrule{2-6}
 & 0.5 & 3.493 & 0.500 & 0.502 & (0.002, 0.003)\\
\cmidrule{2-6}
 & 0.7 & 3.148 & 0.501 & 0.508 & (0.008, 0.011)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash wAFROC} & 0.9 & 2.881 & 0.504 & 0.520 & (0.020, 0.027)\\
\cmidrule{1-6}
 & 0.3 & 1.572 & 0.325 & 0.542 & (0.580, 0.085)\\
\cmidrule{2-6}
 & 0.5 & 1.582 & 0.358 & 0.569 & (0.569, 0.140)\\
\cmidrule{2-6}
 & 0.7 & 1.591 & 0.389 & 0.594 & (0.558, 0.194)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash Youden} & 0.9 & 1.601 & 0.420 & 0.619 & (0.547, 0.246)\\
\bottomrule
\end{tabular}}
\end{table}
