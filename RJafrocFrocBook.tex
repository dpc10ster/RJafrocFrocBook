...
\NormalTok{nu }\OtherTok{\textless{}{-}} \DecValTok{1} 
\NormalTok{zeta1 }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\DecValTok{1}
\NormalTok{K1 }\OtherTok{\textless{}{-}} \DecValTok{5}
\NormalTok{K2 }\OtherTok{\textless{}{-}} \DecValTok{7} 
\NormalTok{Lmax }\OtherTok{\textless{}{-}} \DecValTok{2}
\NormalTok{Lk2 }\OtherTok{\textless{}{-}} \FunctionTok{floor}\NormalTok{(}\FunctionTok{runif}\NormalTok{(K2, }\DecValTok{1}\NormalTok{, Lmax }\SpecialCharTok{+} \DecValTok{1}\NormalTok{))}

\NormalTok{frocDataRaw }\OtherTok{\textless{}{-}} \FunctionTok{SimulateFrocDataset}\NormalTok{(}
  ...
  \AttributeTok{perCase =}\NormalTok{ Lk2, }
  \AttributeTok{zeta1 =}\NormalTok{ zeta1,}
  \AttributeTok{seed =}\NormalTok{ seed}
\NormalTok{)}

\NormalTok{p1A }\OtherTok{\textless{}{-}} \FunctionTok{PlotEmpiricalOperatingCharacteristics}\NormalTok{(}
  \AttributeTok{dataset =}\NormalTok{ frocDataRaw, }
  \AttributeTok{trts=} \DecValTok{1}\NormalTok{, }\AttributeTok{rdrs =} \DecValTok{1}\NormalTok{, }\AttributeTok{opChType =} \StringTok{"FROC"}\NormalTok{, }
  \AttributeTok{legend.position =} \StringTok{"NULL"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{Plot }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"A"}\NormalTok{)}

\NormalTok{p1B }\OtherTok{\textless{}{-}} \FunctionTok{PlotEmpiricalOperatingCharacteristics}\NormalTok{(}
  \AttributeTok{dataset =}\NormalTok{ frocDataRaw, }
  \AttributeTok{trts=} \DecValTok{1}\NormalTok{, }\AttributeTok{rdrs =} \DecValTok{1}\NormalTok{, }\AttributeTok{opChType =} \StringTok{"AFROC"}\NormalTok{, }
  \AttributeTok{legend.position =} \StringTok{"NULL"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{Plot }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"B"}\NormalTok{)}

\NormalTok{p1C }\OtherTok{\textless{}{-}} \FunctionTok{PlotEmpiricalOperatingCharacteristics}\NormalTok{(}
  \AttributeTok{dataset =}\NormalTok{ frocDataRaw, }
  \AttributeTok{trts=} \DecValTok{1}\NormalTok{, }\AttributeTok{rdrs =} \DecValTok{1}\NormalTok{, }\AttributeTok{opChType =} \StringTok{"ROC"}\NormalTok{, }
  \AttributeTok{legend.position =} \StringTok{"NULL"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{Plot }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"C"}\NormalTok{)}

\NormalTok{frocDataRaw\_1\_5\_7 }\OtherTok{\textless{}{-}}\NormalTok{ frocDataRaw }\CommentTok{\# seed 1, K1 = 5, K2 = 7}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{str}\NormalTok{(frocDataRaw)}
\CommentTok{\#\textgreater{} List of 3}
\CommentTok{\#\textgreater{}  $ ratings     :List of 3}
\CommentTok{\#\textgreater{}   ..$ NL   : num [1, 1, 1:12, 1:3] {-}Inf 0.487 0.738 0.576 {-}Inf ...}
\CommentTok{\#\textgreater{}   ..$ LL   : num [1, 1, 1:7, 1:2] {-}Inf {-}Inf {-}0.238 1.919 {-}Inf ...}
\CommentTok{\#\textgreater{}   ..$ LL\_IL: logi NA}
\CommentTok{\#\textgreater{}  $ lesions     :List of 3}
\CommentTok{\#\textgreater{}   ..$ perCase: num [1:7] 1 1 2 2 1 2 2}
\CommentTok{\#\textgreater{}   ..$ IDs    : num [1:7, 1:2] 1 1 1 1 1 ...}
\CommentTok{\#\textgreater{}   ..$ weights: num [1:7, 1:2] 1 1 0.5 0.5 1 ...}
\CommentTok{\#\textgreater{}  $ descriptions:List of 7}
\CommentTok{\#\textgreater{}   ..$ fileName     : chr "NA"}
\CommentTok{\#\textgreater{}   ..$ type         : chr "FROC"}
\CommentTok{\#\textgreater{}   ..$ name         : logi NA}
\CommentTok{\#\textgreater{}   ..$ truthTableStr: logi NA}
\CommentTok{\#\textgreater{}   ..$ design       : chr "FCTRL"}
\CommentTok{\#\textgreater{}   ..$ modalityID   : chr "1"}
\CommentTok{\#\textgreater{}   ..$ readerID     : chr "1"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{frocDataRaw}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{NL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,,]}
\CommentTok{\#\textgreater{}              [,1]       [,2] [,3]}
\CommentTok{\#\textgreater{}  [1,]        {-}Inf       {-}Inf {-}Inf}
\CommentTok{\#\textgreater{}  [2,]  0.48742905       {-}Inf {-}Inf}
\CommentTok{\#\textgreater{}  [3,]  0.73832471       {-}Inf {-}Inf}
\CommentTok{\#\textgreater{}  [4,]  0.57578135 {-}0.3053884 {-}Inf}
\CommentTok{\#\textgreater{}  [5,]        {-}Inf       {-}Inf {-}Inf}
\CommentTok{\#\textgreater{}  [6,]  1.51178117  0.3898432 {-}Inf}
\CommentTok{\#\textgreater{}  [7,]  1.12493092 {-}0.6212406 {-}Inf}
\CommentTok{\#\textgreater{}  [8,] {-}0.04493361       {-}Inf {-}Inf}
\CommentTok{\#\textgreater{}  [9,] {-}0.01619026       {-}Inf {-}Inf}
\CommentTok{\#\textgreater{} [10,]        {-}Inf       {-}Inf {-}Inf}
\CommentTok{\#\textgreater{} [11,]        {-}Inf       {-}Inf {-}Inf}
\CommentTok{\#\textgreater{} [12,]        {-}Inf       {-}Inf {-}Inf}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{frocDataRaw1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{NL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,,]}
\CommentTok{\#\textgreater{}              [,1]       [,2]    [,3]}
\CommentTok{\#\textgreater{}  [1,]        {-}Inf       {-}Inf    {-}Inf}
\CommentTok{\#\textgreater{}  [2,]  0.48742905       {-}Inf    {-}Inf}
\CommentTok{\#\textgreater{}  [3,]  0.73832471       {-}Inf    {-}Inf}
...
\CommentTok{\#\textgreater{}  [5,]        {-}Inf       {-}Inf    {-}Inf}
\CommentTok{\#\textgreater{}  [6,]  1.51178117  0.3898432    {-}Inf}
\CommentTok{\#\textgreater{}  [7,]  1.12493092 {-}0.6212406 {-}2.2147}
\CommentTok{\#\textgreater{}  [8,] {-}0.04493361       {-}Inf    {-}Inf}
\CommentTok{\#\textgreater{}  [9,] {-}0.01619026       {-}Inf    {-}Inf}
\CommentTok{\#\textgreater{} [10,]        {-}Inf       {-}Inf    {-}Inf}
\CommentTok{\#\textgreater{} [11,]        {-}Inf       {-}Inf    {-}Inf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{frocDataRaw}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{LL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,,]}
\CommentTok{\#\textgreater{}            [,1]      [,2]}
\CommentTok{\#\textgreater{} [1,]       {-}Inf      {-}Inf}
\CommentTok{\#\textgreater{} [2,]       {-}Inf      {-}Inf}
\CommentTok{\#\textgreater{} [3,] {-}0.2375384      {-}Inf}
\CommentTok{\#\textgreater{} [4,]  1.9189774      {-}Inf}
\CommentTok{\#\textgreater{} [5,]       {-}Inf      {-}Inf}
\CommentTok{\#\textgreater{} [6,]  1.0745650      {-}Inf}
\CommentTok{\#\textgreater{} [7,]  1.5036080 0.9428932}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{frocDataRaw1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{LL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,,]}
\CommentTok{\#\textgreater{}            [,1]      [,2]}
\CommentTok{\#\textgreater{} [1,]       {-}Inf      {-}Inf}
\CommentTok{\#\textgreater{} [2,]       {-}Inf      {-}Inf}
\CommentTok{\#\textgreater{} [3,] {-}0.2375384      {-}Inf}
...
\NormalTok{frocDataBinned }\OtherTok{\textless{}{-}} \FunctionTok{DfBinDataset}\NormalTok{(}
\NormalTok{  frocDataRaw,}
  \AttributeTok{desiredNumBins =} \DecValTok{5}\NormalTok{,}
  \AttributeTok{opChType =} \StringTok{"FROC"}\NormalTok{)}

\NormalTok{p4A }\OtherTok{\textless{}{-}} \FunctionTok{PlotEmpiricalOperatingCharacteristics}\NormalTok{(}
  \AttributeTok{dataset =}\NormalTok{ frocDataBinned, }
  \AttributeTok{trts=} \DecValTok{1}\NormalTok{, }\AttributeTok{rdrs =} \DecValTok{1}\NormalTok{, }\AttributeTok{opChType =} \StringTok{"FROC"}\NormalTok{, }
  \AttributeTok{legend.position =} \StringTok{"NULL"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{Plot }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"A"}\NormalTok{)}

\NormalTok{p4B }\OtherTok{\textless{}{-}} \FunctionTok{PlotEmpiricalOperatingCharacteristics}\NormalTok{(}
  \AttributeTok{dataset =}\NormalTok{ frocDataBinned, }
  \AttributeTok{trts=} \DecValTok{1}\NormalTok{, }\AttributeTok{rdrs =} \DecValTok{1}\NormalTok{, }\AttributeTok{opChType =} \StringTok{"AFROC"}\NormalTok{, }
  \AttributeTok{legend.position =} \StringTok{"NULL"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{Plot }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"B"}\NormalTok{)}

\NormalTok{p4C }\OtherTok{\textless{}{-}} \FunctionTok{PlotEmpiricalOperatingCharacteristics}\NormalTok{(}
  \AttributeTok{dataset =}\NormalTok{ frocDataBinned, }
  \AttributeTok{trts=} \DecValTok{1}\NormalTok{, }\AttributeTok{rdrs =} \DecValTok{1}\NormalTok{, }\AttributeTok{opChType =} \StringTok{"ROC"}\NormalTok{, }
  \AttributeTok{legend.position =} \StringTok{"NULL"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{Plot }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"C"}\NormalTok{)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{str}\NormalTok{(frocDataBinnedSeed1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{NL)}
\CommentTok{\#\textgreater{}  num [1, 1, 1:120, 1:4] {-}Inf 4 2 3 {-}Inf ...}
\FunctionTok{table}\NormalTok{(frocDataBinnedSeed1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{NL)}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} {-}Inf    1    2    3    4 }
\CommentTok{\#\textgreater{}  376   35   30   23   16}
\FunctionTok{sum}\NormalTok{(}\FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{table}\NormalTok{(frocDataBinnedSeed1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{NL)))}
\CommentTok{\#\textgreater{} [1] 480}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{str}\NormalTok{(frocDataBinnedSeed1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{LL)}
\CommentTok{\#\textgreater{}  num [1, 1, 1:70, 1:2] 3 4 4 4 3 ...}
\FunctionTok{table}\NormalTok{(frocDataBinnedSeed1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{LL)}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} {-}Inf    1    2    3    4    5 }
\CommentTok{\#\textgreater{}   79    5   10   17   24    5}
\FunctionTok{sum}\NormalTok{(}\FunctionTok{as.numeric}\NormalTok{(}\FunctionTok{table}\NormalTok{(frocDataBinnedSeed1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{LL)))}
\CommentTok{\#\textgreater{} [1] 140}
\FunctionTok{sum}\NormalTok{(Lk2Seed1)}
\CommentTok{\#\textgreater{} [1] 104}
\FunctionTok{sum}\NormalTok{(Lk2Seed1) }\SpecialCharTok{{-}} \FunctionTok{sum}\NormalTok{(}\FunctionTok{as.vector}\NormalTok{(}\FunctionTok{table}\NormalTok{(frocDataBinnedSeed1}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{LL))[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{6}\NormalTok{])}
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\FunctionTok{source}\NormalTok{(}\FunctionTok{here}\NormalTok{(}\StringTok{"R/CH13{-}CadVsRadPlots/CadVsRadPlots.R"}\NormalTok{))}

\NormalTok{nu }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{lambda }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{K1 }\OtherTok{\textless{}{-}} \DecValTok{500}
\NormalTok{K2 }\OtherTok{\textless{}{-}} \DecValTok{700}
\NormalTok{mu1 }\OtherTok{\textless{}{-}} \FloatTok{1.0}
\NormalTok{mu2 }\OtherTok{\textless{}{-}} \FloatTok{1.5}
\NormalTok{zeta1\_1 }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\DecValTok{1}
\NormalTok{zeta1\_2 }\OtherTok{\textless{}{-}} \FloatTok{1.5}
\NormalTok{Lmax }\OtherTok{\textless{}{-}} \DecValTok{2}
\NormalTok{seed }\OtherTok{\textless{}{-}} \DecValTok{1}

\NormalTok{ret }\OtherTok{\textless{}{-}} \FunctionTok{do\_one\_figure}\NormalTok{ (}
\NormalTok{  seed, Lmax, mu1, }
\NormalTok{  mu2, lambda, nu, zeta1\_1, zeta1\_2, K1, K2)}

\NormalTok{froc\_plot\_1A }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{froc\_plot\_A}
\NormalTok{wafroc\_plot\_1B }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{wafroc\_plot\_B}
\NormalTok{roc\_plot\_1C }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{roc\_plot\_C}
\NormalTok{froc\_plot\_1D }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{froc\_plot\_D}
\NormalTok{wafroc\_plot\_1E }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{wafroc\_plot\_E}
\NormalTok{roc\_plot\_1F }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{roc\_plot\_F}
\NormalTok{wafroc\_1\_1B }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{wafroc\_1\_B}
\NormalTok{wafroc\_2\_1B }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{wafroc\_2\_B}
\NormalTok{roc\_1\_1C }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{roc\_1\_C}
\NormalTok{roc\_2\_1C }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{roc\_2\_C}
\NormalTok{wafroc\_1\_1E }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{wafroc\_1\_E}
\NormalTok{wafroc\_2\_1E }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{wafroc\_2\_E}
\NormalTok{roc\_1\_1F }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{roc\_1\_F}
\NormalTok{roc\_2\_1F }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{roc\_2\_F}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x1 }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(frocData}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{NL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,,])}
\FunctionTok{colnames}\NormalTok{(x1) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"location1"}\NormalTok{, }\StringTok{"location2"}\NormalTok{)}
\NormalTok{x2 }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(frocData}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{LL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,,])}
\FunctionTok{colnames}\NormalTok{(x2) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"location1"}\NormalTok{, }\StringTok{"location2"}\NormalTok{)}
\NormalTok{x1}
\CommentTok{\#\textgreater{}    location1 location2}
\CommentTok{\#\textgreater{} 1       {-}Inf      {-}Inf}
\CommentTok{\#\textgreater{} 2  0.4874291      {-}Inf}
\CommentTok{\#\textgreater{} 3  0.7383247 0.5757814}
\CommentTok{\#\textgreater{} 4 {-}0.3053884      {-}Inf}
\CommentTok{\#\textgreater{} 5  1.5117812      {-}Inf}
\CommentTok{\#\textgreater{} 6       {-}Inf      {-}Inf}
\CommentTok{\#\textgreater{} 7       {-}Inf      {-}Inf}
\CommentTok{\#\textgreater{} 8       {-}Inf      {-}Inf}
\NormalTok{x2}
\CommentTok{\#\textgreater{}    location1 location2}
\CommentTok{\#\textgreater{} 1  0.8523430      {-}Inf}
\CommentTok{\#\textgreater{} 2 {-}0.2146999      {-}Inf}
\CommentTok{\#\textgreater{} 3  1.5884892      {-}Inf}
\CommentTok{\#\textgreater{} 4  2.9438362   1.98381}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(ret}\SpecialCharTok{$}\NormalTok{fittedPlot)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{startIndx }\OtherTok{\textless{}{-}}  \DecValTok{2}
\NormalTok{endIndx }\OtherTok{\textless{}{-}} \DecValTok{3}
\NormalTok{ret }\OtherTok{\textless{}{-}} \FunctionTok{Compare3ProperRocFits}\NormalTok{(datasetNames,}
                             \AttributeTok{startIndx =}\NormalTok{ startIndx, }
                             \AttributeTok{endIndx =}\NormalTok{ endIndx, }
                             \AttributeTok{reAnalyze =} \ConstantTok{FALSE}\NormalTok{)}

\NormalTok{resultsArr }\OtherTok{\textless{}{-}}\NormalTok{ plotArr }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\FunctionTok{list}\NormalTok{(), }
                               \AttributeTok{dim =} \FunctionTok{c}\NormalTok{(endIndx }\SpecialCharTok{{-}}\NormalTok{ startIndx }\SpecialCharTok{+} \DecValTok{1}\NormalTok{))}

\ControlFlowTok{for}\NormalTok{ (f }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{(endIndx}\SpecialCharTok{{-}}\NormalTok{startIndx}\SpecialCharTok{+}\DecValTok{1}\NormalTok{)) \{}
\NormalTok{  plotArr[[f]] }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{allPlots[[f]]}
\NormalTok{  resultsArr[[f]] }\OtherTok{\textless{}{-}}\NormalTok{ ret}\SpecialCharTok{$}\NormalTok{allResults[[f]]}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f }\OtherTok{\textless{}{-}} \DecValTok{1}\NormalTok{;i }\OtherTok{\textless{}{-}} \DecValTok{1}\NormalTok{; j }\OtherTok{\textless{}{-}} \DecValTok{2}\NormalTok{;J }\OtherTok{\textless{}{-}} \DecValTok{5}
\FunctionTok{cat}\NormalTok{(}\StringTok{"RSM parameters, Van Dyke Dataset, treatment 1, reader 2:"}\NormalTok{,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{mu = "}\NormalTok{,        resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{mu,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{lambdaP = "}\NormalTok{,   resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{lambdaP,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{nuP = "}\NormalTok{,       resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{nuP,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{zeta\_1 = "}\NormalTok{,    }\FunctionTok{as.numeric}\NormalTok{(resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{zetas[}\DecValTok{1}\NormalTok{]),}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{AUC = "}\NormalTok{,       resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{AUC,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{sigma\_AUC = "}\NormalTok{, }\FunctionTok{as.numeric}\NormalTok{(resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{StdAUC),}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{NLLini = "}\NormalTok{,    resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{NLLIni,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{NLLfin = "}\NormalTok{,    resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retRsm}\SpecialCharTok{$}\NormalTok{NLLFin)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{f }\OtherTok{\textless{}{-}} \DecValTok{1}\NormalTok{;i }\OtherTok{\textless{}{-}} \DecValTok{1}\NormalTok{; j }\OtherTok{\textless{}{-}} \DecValTok{2}\NormalTok{;J }\OtherTok{\textless{}{-}} \DecValTok{5}
\FunctionTok{cat}\NormalTok{(}\StringTok{"CBM parameters, Van Dyke Dataset, treatment 1, reader 2:"}\NormalTok{,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{mu = "}\NormalTok{,         resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retCbm}\SpecialCharTok{$}\NormalTok{mu,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{alpha = "}\NormalTok{,      resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retCbm}\SpecialCharTok{$}\NormalTok{alpha,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{zeta\_1 = "}\NormalTok{,     }\FunctionTok{as.numeric}\NormalTok{(resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retCbm}\SpecialCharTok{$}\NormalTok{zetas[}\DecValTok{1}\NormalTok{]),}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{AUC = "}\NormalTok{,        resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retCbm}\SpecialCharTok{$}\NormalTok{AUC,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{sigma\_AUC = "}\NormalTok{,  }\FunctionTok{as.numeric}\NormalTok{(resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retCbm}\SpecialCharTok{$}\NormalTok{StdAUC),}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{NLLini = "}\NormalTok{,     resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retCbm}\SpecialCharTok{$}\NormalTok{NLLIni,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{NLLfin = "}\NormalTok{,     resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{retCbm}\SpecialCharTok{$}\NormalTok{NLLFin)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{f }\OtherTok{\textless{}{-}} \DecValTok{1}\NormalTok{;i }\OtherTok{\textless{}{-}} \DecValTok{1}\NormalTok{; j }\OtherTok{\textless{}{-}} \DecValTok{2}\NormalTok{;J }\OtherTok{\textless{}{-}} \DecValTok{5}
\FunctionTok{cat}\NormalTok{(}\StringTok{"PROPROC parameters, Van Dyke Dataset, treatment 1, reader 2:"}\NormalTok{,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{c = "}\NormalTok{,     resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{c1,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{d\_a = "}\NormalTok{,   resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{da,}
\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{AUC = "}\NormalTok{,   resultsArr[[f]][[(i}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{J}\SpecialCharTok{+}\NormalTok{j]]}\SpecialCharTok{$}\NormalTok{aucProp)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{wAFROC }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (}
\NormalTok{  zeta1, }
\NormalTok{  mu, }
\NormalTok{  lambda, }
\NormalTok{  nu, }
...
\NormalTok{  x }\OtherTok{\textless{}{-}} \FunctionTok{UtilAnalyticalAucsRSM}\NormalTok{(}
\NormalTok{    mu, }
\NormalTok{    lambda, }
\NormalTok{    nu, zeta1, }
\NormalTok{    lesDistr, }
\NormalTok{    relWeights)}\SpecialCharTok{$}\NormalTok{aucwAFROC}
  \CommentTok{\# return negative of aucwAFROC }
  \CommentTok{\# (as optimize finds minimum of function)}
  \FunctionTok{return}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{x)}
  
\NormalTok{\}}


\NormalTok{Youden }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (}
\NormalTok{  zeta1, }
\NormalTok{  mu, }
\NormalTok{  lambda, }
\NormalTok{  nu, }
...
\NormalTok{  relWeights) \{}
  ...
  \CommentTok{\# and subtract 1, i.e., Youden\textquotesingle{}s index}
\NormalTok{  x }\OtherTok{\textless{}{-}} \FunctionTok{RSM\_yROC}\NormalTok{(}
\NormalTok{    zeta1, }
\NormalTok{    mu, }
\NormalTok{    lambda, }
\NormalTok{    nu, }
\NormalTok{    lesDistr) }\SpecialCharTok{+} 
\NormalTok{    (}\DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{RSM\_xROC}\NormalTok{(zeta1, lambda}\SpecialCharTok{/}\NormalTok{mu)) }\SpecialCharTok{{-}} \DecValTok{1}
...
\NormalTok{nu }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{lambdaArr }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{10}\NormalTok{,}\DecValTok{15}\NormalTok{)}
\NormalTok{fomMaxArr }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\AttributeTok{dim =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\FunctionTok{length}\NormalTok{(lambdaArr)))}
\NormalTok{zetaOptArr }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\AttributeTok{dim =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\FunctionTok{length}\NormalTok{(lambdaArr)))}
\NormalTok{rocAucArr }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\AttributeTok{dim =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\FunctionTok{length}\NormalTok{(lambdaArr)))}
\NormalTok{nlfOptArr }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\AttributeTok{dim =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\FunctionTok{length}\NormalTok{(lambdaArr)))}
\NormalTok{llfOptArr }\OtherTok{\textless{}{-}} \FunctionTok{array}\NormalTok{(}\AttributeTok{dim =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\FunctionTok{length}\NormalTok{(lambdaArr)))}
...
\ControlFlowTok{for}\NormalTok{ (y }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{) \{}
  \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(lambdaArr)) \{}
    \ControlFlowTok{if}\NormalTok{ (y }\SpecialCharTok{==} \DecValTok{1}\NormalTok{) \{}
\NormalTok{      x }\OtherTok{\textless{}{-}} \FunctionTok{optimize}\NormalTok{(wAFROC, }
                    \AttributeTok{interval =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{5}\NormalTok{,}\DecValTok{5}\NormalTok{), }
\NormalTok{                    mu, }
\NormalTok{                    lambdaArr[i], }
\NormalTok{                    nu, }
\NormalTok{                    lesDistr, }
\NormalTok{                    relWeights)}
\NormalTok{      zetaOptArr[y,i] }\OtherTok{\textless{}{-}}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{minimum}
\NormalTok{      fomMaxArr[y,i] }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\NormalTok{x}\SpecialCharTok{$}\NormalTok{objective }\CommentTok{\# safe to use objective here}
\NormalTok{      rocAucArr[y,i] }\OtherTok{\textless{}{-}} \FunctionTok{UtilAnalyticalAucsRSM}\NormalTok{(}
\NormalTok{        mu, }
\NormalTok{        lambdaArr[i], }
\NormalTok{        nu, }
        \AttributeTok{zeta1 =}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{minimum, }
\NormalTok{        lesDistr, }
\NormalTok{        relWeights)}\SpecialCharTok{$}\NormalTok{aucROC}
\NormalTok{      nlfOptArr[y,i] }\OtherTok{\textless{}{-}} \FunctionTok{RSM\_xFROC}\NormalTok{(}
        \AttributeTok{z =}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{minimum, }
\NormalTok{        mu, }
        \AttributeTok{lambda =}\NormalTok{ lambdaArr[i])}
\NormalTok{      llfOptArr[y,i] }\OtherTok{\textless{}{-}} \FunctionTok{RSM\_yFROC}\NormalTok{(}
        \AttributeTok{z =}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{minimum, }
\NormalTok{        mu, }
\NormalTok{        nu)}
\NormalTok{    \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (y }\SpecialCharTok{==} \DecValTok{2}\NormalTok{) \{}
\NormalTok{      x }\OtherTok{\textless{}{-}} \FunctionTok{optimize}\NormalTok{(Youden, }
                    \AttributeTok{interval =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{5}\NormalTok{,}\DecValTok{5}\NormalTok{), }
\NormalTok{                    mu, }
\NormalTok{                    lambdaArr[i], }
\NormalTok{                    nu, }
...
\NormalTok{                    relWeights)}
\NormalTok{      zetaOptArr[y,i] }\OtherTok{\textless{}{-}}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{minimum}
\NormalTok{      fomMaxArr[y,i] }\OtherTok{\textless{}{-}} \FunctionTok{UtilAnalyticalAucsRSM}\NormalTok{(}
\NormalTok{        mu, }
\NormalTok{        lambdaArr[i], }
\NormalTok{        nu, }
        \AttributeTok{zeta1 =}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{minimum, }
...
\NormalTok{        mu, }
        \AttributeTok{lambda =}\NormalTok{ lambdaArr[i])}
\NormalTok{      llfOptArr[y,i] }\OtherTok{\textless{}{-}} \FunctionTok{RSM\_yFROC}\NormalTok{(}
        \AttributeTok{z =}\NormalTok{ x}\SpecialCharTok{$}\NormalTok{minimum, mu, nu)}
\NormalTok{    \} }\ControlFlowTok{else} \FunctionTok{stop}\NormalTok{(}\StringTok{"incorrect y"}\NormalTok{)}
\NormalTok{  \}}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fileName }\OtherTok{\textless{}{-}} \StringTok{"R/CH83{-}ClassificationTask/File1.xlsx"}
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{DfReadDataFile}\NormalTok{(}\AttributeTok{fileName =}\NormalTok{ fileName)}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{NL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,,]}
\CommentTok{\#\textgreater{}      [,1] [,2] [,3]}
\CommentTok{\#\textgreater{} [1,]  5.5  1.2 {-}Inf}
\CommentTok{\#\textgreater{} [2,]  7.0  2.3  2.1}
\CommentTok{\#\textgreater{} [3,]  1.4  6.1 {-}Inf}
\NormalTok{x}\SpecialCharTok{$}\NormalTok{ratings}\SpecialCharTok{$}\NormalTok{LL[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,,]}
\CommentTok{\#\textgreater{}      [,1] [,2] [,3] [,4]}
\CommentTok{\#\textgreater{} [1,]  5.0 {-}Inf {-}Inf {-}Inf}
\CommentTok{\#\textgreater{} [2,]  6.1  7.1 {-}Inf  2.3}
\CommentTok{\#\textgreater{} [3,]  5.7 {-}Inf {-}Inf {-}Inf}
\end{Highlighting}
\end{Shaded}
