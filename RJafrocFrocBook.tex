...
\chapter{How to analyze a dataset with zero non-diseased cases}\label{analyze-diseased-only-dataset}}
...
\section{TBA Handling diseased-only datasets}\label{diseased-only-dataset}}
