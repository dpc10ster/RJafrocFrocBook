...
\begin{figure}
\centering
\includegraphics{21-optim-op-point1_files/figure-latex/binormal-model-threshold-dependence-2-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-mu-froc-1.pdf}
\caption{\label{fig:optim-op-point-low-performance-vary-mu-froc}Low performance varying \(\mu\) FROC plots with superimposed operating points. The red dot corresponds to wAFROC AUC optimization and the black dot to Youden-index optimization. The values of \(\mu\) are: top-left \(\mu = 2\), top-right \(\mu = 3\), bottom-left \(\mu = 4\) and bottom-right \(\mu = 5\).}
\end{figure}
