...
\NormalTok{ret <-}\StringTok{ }\KeywordTok{Compare3ProperRocFits}\NormalTok{(datasetNames, }\KeywordTok{which}\NormalTok{(datasetNames }\OperatorTok{==}\StringTok{ "VD"}\NormalTok{))}
\NormalTok{resultsVD <-}\StringTok{ }\NormalTok{ret}\OperatorTok{$}\NormalTok{allResults}
\NormalTok{plotsVD <-}\StringTok{ }\NormalTok{ret}\OperatorTok{$}\NormalTok{allPlots}

\CommentTok{# FR dataset}
\NormalTok{ret <-}\StringTok{ }\KeywordTok{Compare3ProperRocFits}\NormalTok{(datasetNames, }\KeywordTok{which}\NormalTok{(datasetNames }\OperatorTok{==}\StringTok{ "FR"}\NormalTok{))}
\NormalTok{resultsFR <-}\StringTok{ }\NormalTok{ret}\OperatorTok{$}\NormalTok{allResults}
\NormalTok{plotsFR <-}\StringTok{ }\NormalTok{ret}\OperatorTok{$}\NormalTok{allPlots}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu <-}\StringTok{ }\NormalTok{resultsVD[[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{retRsm}\OperatorTok{$}\NormalTok{mu}
\NormalTok{lambda <-}\StringTok{ }\NormalTok{resultsVD[[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{retRsm}\OperatorTok{$}\NormalTok{lambda}
\NormalTok{nu <-}\StringTok{ }\NormalTok{resultsVD[[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]]}\OperatorTok{$}\NormalTok{retRsm}\OperatorTok{$}\NormalTok{nu}
\NormalTok{f <-}\StringTok{ }\KeywordTok{which}\NormalTok{(datasetNames }\OperatorTok{==}\StringTok{ "VD"}\NormalTok{)}
\NormalTok{fileName <-}\StringTok{ }\NormalTok{datasetNames[f]}
\NormalTok{theData <-}\StringTok{ }\KeywordTok{get}\NormalTok{(}\KeywordTok{sprintf}\NormalTok{(}\StringTok{"dataset%02d"}\NormalTok{, f)) }\CommentTok{# the datasets already exist as R objects}
\NormalTok{lesDistr <-}\StringTok{ }\KeywordTok{UtilLesionDistrVector}\NormalTok{(theData) }\CommentTok{# RSM ROC fitting needs to know lesDistr}

\NormalTok{ret <-}\StringTok{ }\KeywordTok{LesionLocLesionCls}\NormalTok{(mu, lambda, nu, lesDistr)}
\NormalTok{L_L <-}\StringTok{ }\NormalTok{ret}\OperatorTok{$}\NormalTok{L_L}
\NormalTok{L_C <-}\StringTok{ }\NormalTok{ret}\OperatorTok{$}\NormalTok{L_C}
  
\KeywordTok{cat}\NormalTok{(}\KeywordTok{sprintf}\NormalTok{(}\StringTok{"VD data i=1 j=2:  L_L = %7.3f, L_C = %7.3f"}\NormalTok{, L_L, L_C), }\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
For the Franken dataset the values are accessed as \texttt{resultsFR{[}{[}i,j{]}{]}}.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\NormalTok{RRFC_1T_PCL_}\DecValTok{0}\NormalTok{_}\DecValTok{2}
\NormalTok{fom_individual_rad <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{t}\NormalTok{(x}\OperatorTok{$}\NormalTok{fomRAD))}
\KeywordTok{colnames}\NormalTok{(fom_individual_rad) <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"rdr"}\NormalTok{, }\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{9}\NormalTok{))}

\NormalTok{stats <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{fomCAD =}\NormalTok{ x}\OperatorTok{$}\NormalTok{fomCAD, }\DataTypeTok{avgRadFom =}\NormalTok{ x}\OperatorTok{$}\NormalTok{avgRadFom, }\DataTypeTok{avgDiffFom =}\NormalTok{ x}\OperatorTok{$}\NormalTok{avgDiffFom, }\DataTypeTok{varR =}\NormalTok{ x}\OperatorTok{$}\NormalTok{varR, }\DataTypeTok{Tstat =}\NormalTok{ x}\OperatorTok{$}\NormalTok{Tstat, }\DataTypeTok{df =}\NormalTok{ x}\OperatorTok{$}\NormalTok{df, }\DataTypeTok{pval =}\NormalTok{ x}\OperatorTok{$}\NormalTok{pval)}

\NormalTok{ConfidenceIntervals <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{CIAvgRadFom =}\NormalTok{ x}\OperatorTok{$}\NormalTok{CIAvgRadFom, }\DataTypeTok{CIAvgDiffFom =}\NormalTok{ x}\OperatorTok{$}\NormalTok{CIAvgDiffFom)}
\KeywordTok{rownames}\NormalTok{(ConfidenceIntervals) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Lower"}\NormalTok{, }\StringTok{"Upper"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\NormalTok{RRRC_2T_PCL_}\DecValTok{0}\NormalTok{_}\DecValTok{2}

\NormalTok{fom_individual_rad <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{t}\NormalTok{(x}\OperatorTok{$}\NormalTok{fomRAD))}
\KeywordTok{colnames}\NormalTok{(fom_individual_rad) <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"rdr"}\NormalTok{, }\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{9}\NormalTok{))}

\NormalTok{stats1 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{fomCAD =}\NormalTok{ x}\OperatorTok{$}\NormalTok{fomCAD, }\DataTypeTok{avgRadFom =}\NormalTok{ x}\OperatorTok{$}\NormalTok{avgRadFom, }\DataTypeTok{avgDiffFom =}\NormalTok{ x}\OperatorTok{$}\NormalTok{avgDiffFom)}

\NormalTok{stats2 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{varR =}\NormalTok{ x}\OperatorTok{$}\NormalTok{varR, }\DataTypeTok{varTR =}\NormalTok{ x}\OperatorTok{$}\NormalTok{varTR, }
                 \DataTypeTok{cov1 =}\NormalTok{ x}\OperatorTok{$}\NormalTok{cov1, }\DataTypeTok{cov2 =}\NormalTok{ x}\OperatorTok{$}\NormalTok{cov2 , }
                 \DataTypeTok{cov3 =}\NormalTok{ x}\OperatorTok{$}\NormalTok{cov3 , }\DataTypeTok{Var =}\NormalTok{ x}\OperatorTok{$}\NormalTok{varError, }
                 \DataTypeTok{FStat =}\NormalTok{ x}\OperatorTok{$}\NormalTok{FStat, }\DataTypeTok{df =}\NormalTok{ x}\OperatorTok{$}\NormalTok{df, }\DataTypeTok{pval =}\NormalTok{ x}\OperatorTok{$}\NormalTok{pval)}
\end{Highlighting}
\end{Shaded}
...
The wAFROC-AUC figure of merit is implemented in the \texttt{RJafroc} function \texttt{UtilAnalyticalAucsRSM}. The Youden-index is defined as sensitivity plus specificity minus 1. Sensitivity is implemented in function \texttt{RSM\_yROC} and specificity is the complement of \texttt{RSM\_xROC}.
...
\def\labelenumi{\arabic{enumi}.}
\item
  FROC plots: The wAFROC-AUC based optimal thresholds are smaller (corresponding to laxer reporting criteria) than the corresponding Youden-index based optimal thresholds. The Youden-index based operating point (black dot) is below-left the wAFROC-AUC based operating point (red dot). The difference between the two points decreases with increasing \(\lambda\). These effects are illustrated in Fig. \ref{fig:optim-op-point-vary-lambda-froc}.
\item
  wAFROC and ROC plots: The Youden-index based optimizations yield lower performance than the corresponding wAFROC-AUC based optimizations and the difference in wAFROC-AUCs or ROC-AUCs decreases with increasing \(\lambda\). These effects are illustrated in Fig. \ref{fig:optim-op-point-vary-lambda-wafroc} for the wAFROC and \ref{fig:optim-op-point-vary-lambda-roc} for the ROC.
\item
  For either FOM as \(\lambda\) increases \(\zeta_1\) increases (stricter reporting threshold). \textbf{When CAD performance decreases the algorithm adopts a stricter reporting criterion.}
\end{enumerate}
...
\begin{figure}
\centering
\includegraphics{21-optim-op-point1_files/figure-latex/optim-op-point-vary-lambda-froc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{21-optim-op-point1_files/figure-latex/optim-op-point-vary-lambda-wafroc-1.pdf}
\caption{\label{fig:optim-op-point-vary-lambda-wafroc}wAFROC plots for the two optimization methods: the ``solid-green solid-red dashed-red'' curve corresponds to wAFROC-AUC optimization and the ``solid-green dashed-green'' curve corresponds to Youden-index optimization. The wAFROC-AUC optimizations yield greater performance than do Youden-index optimizations and the difference decreases with increasing \(\lambda\).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{21-optim-op-point1_files/figure-latex/optim-op-point-vary-lambda-roc-1.pdf}
\caption{\label{fig:optim-op-point-vary-lambda-roc}ROC plots for the two optimization methods: the ``solid-green solid-red dashed-red'' curve corresponds to wAFROC-AUC optimization and the ``solid-green dashed-green'' curve corresponds to Youden-index optimization. The wAFROC-AUC optimizations yield greater performance than Youden-index optimizations and the difference decreases with increasing \(\lambda\).}
\end{figure}
...
{\centering \includegraphics[width=300pt]{21-optim-op-point1_files/figure-latex/binormal-model-threshold-dependence-2-1} 

}

\caption{In the region above the dot the proper curve is above the dotted line, meaning performance of an observer who adopts a finite $\zeta_1$ is less than performance of an observer who adopts $\zeta_1 = -\infty$.}\label{fig:binormal-model-threshold-dependence-2}
\end{figure}
...
\hypertarget{optim-op-point-summary-comments}{%
\section{Summary comments}\label{optim-op-point-summary-comments}}
...
I do not have any CAD FROC datasets. The standalone CAD LROC dataset described in \citep{hupse2013standalone} was used to create a simulated FROC (i.e., ROC-AUC equivalent) dataset which is embedded in \texttt{RJafroc} as object \texttt{datasetCadSimuFroc}. In the following code the first reader for this dataset, corresponding to CAD, is extracted using \texttt{DfExtractDataset} (the other reader data, corresponding to radiologists, are ignored). The function \texttt{DfFroc2Roc} converts \texttt{dsCad} to an ROC dataset. The function \texttt{DfBinDataset} bins the data to about 7 bins. Each diseased case contains one lesion: \texttt{lesDistr\ =\ c(1)}. \texttt{FitRsmRoc} fits the binned ROC dataset to the radiological search model (RSM). Object \texttt{fit} contains the RSM parameters required to perform the optimizations described in previous sections.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ds <-}\StringTok{ }\NormalTok{RJafroc}\OperatorTok{::}\NormalTok{datasetCadSimuFroc}
\NormalTok{dsCad <-}\StringTok{ }\NormalTok{RJafroc}\OperatorTok{::}\KeywordTok{DfExtractDataset}\NormalTok{(ds, }\DataTypeTok{rdrs =} \DecValTok{1}\NormalTok{)}
\NormalTok{dsCadRoc <-}\StringTok{ }\NormalTok{RJafroc}\OperatorTok{::}\KeywordTok{DfFroc2Roc}\NormalTok{(dsCad)}
\NormalTok{dsCadRocBinned <-}\StringTok{ }\NormalTok{RJafroc}\OperatorTok{::}\KeywordTok{DfBinDataset}\NormalTok{(dsCadRoc, }\DataTypeTok{opChType =} \StringTok{"ROC"}\NormalTok{)}
\NormalTok{lesDistrCad <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{) }\CommentTok{# LROC dataset has one lesion per diseased case}
\NormalTok{relWeightsCad <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{fit <-}\StringTok{ }\NormalTok{RJafroc}\OperatorTok{::}\KeywordTok{FitRsmRoc}\NormalTok{(dsCadRocBinned, lesDistrCad)}
\KeywordTok{cat}\NormalTok{(}\KeywordTok{sprintf}\NormalTok{(}\StringTok{"fitted values: mu = %5.3f,"}\NormalTok{, fit}\OperatorTok{$}\NormalTok{mu), }
    \KeywordTok{sprintf}\NormalTok{(}\StringTok{"lambda = %5.3f,"}\NormalTok{, fit}\OperatorTok{$}\NormalTok{lambda), }
    \KeywordTok{sprintf}\NormalTok{(}\StringTok{"nu = %5.3f."}\NormalTok{, fit}\OperatorTok{$}\NormalTok{nu)) }
\CommentTok{#> fitted values: mu = 2.756, lambda = 6.778, nu = 0.803.}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{21-optim-op-point1_files/figure-latex/optim-op-point-application-froc-1.pdf}
\caption{\label{fig:optim-op-point-application-froc}FROC plots with superposed optimal operating points. The red dot is using wAFROC-AUC optimization and black dot is using Youden-index optimization.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{21-optim-op-point1_files/figure-latex/optim-op-point-application-wafroc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{21-optim-op-point1_files/figure-latex/optim-op-point-application-roc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-vary-nu-froc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-vary-nu-wafroc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-vary-nu-roc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-vary-mu-froc-1.pdf}
\caption{\label{fig:optim-op-point-vary-mu-froc}Varying \(\mu\) FROC plots with superimposed operating points. The red dot corresponds to wAFROC-AUC optimization and the black dot to Youden-index optimization. The values of \(\mu\) are: top-left \(\mu = 1\), top-right \(\mu = 2\), bottom-left \(\mu = 3\) and bottom-right \(\mu = 4\).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-vary-mu-wafroc-1.pdf}
\caption{\label{fig:optim-op-point-vary-mu-wafroc}Varying \(\mu\) wAFROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\mu\) are: top-left \(\mu = 1\), top-right \(\mu = 2\), bottom-left \(\mu = 3\) and bottom-right \(\mu = 4\).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-vary-mu-roc-1.pdf}
\caption{\label{fig:optim-op-point-vary-mu-roc}Varying \(\mu\) ROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\mu\) are: top-left \(\mu = 1\), top-right \(\mu = 2\), bottom-left \(\mu = 3\) and bottom-right \(\mu = 4\).}
\end{figure}
...
\subsection{\texorpdfstring{High performance varying \(\mu\)}{High performance varying \textbackslash mu}}\label{optim-op-point-high-performance-vary-mu}}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-mu-froc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-mu-wafroc-1.pdf}
\caption{\label{fig:optim-op-point-high-performance-vary-mu-wafroc}High performance varying \(\mu\) wAFROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\mu\) are: top-left \(\mu = 2\), top-right \(\mu = 3\), bottom-left \(\mu = 4\) and bottom-right \(\mu = 5\).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-mu-roc-1.pdf}
\caption{\label{fig:optim-op-point-high-performance-vary-mu-roc}High performance varying \(\mu\) ROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\mu\) are: top-left \(\mu = 2\), top-right \(\mu = 3\), bottom-left \(\mu = 4\) and bottom-right \(\mu = 5\).}
\end{figure}

\hypertarget{optim-op-point-low-performance-vary-mu}{%
\subsection{\texorpdfstring{Low performance varying \(\mu\)}{Low performance varying \textbackslash mu}}\label{optim-op-point-low-performance-vary-mu}}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-mu-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-mu-wafroc-1.pdf}
\caption{\label{fig:optim-op-point-low-performance-vary-mu-wafroc}Low performance varying \(\mu\) wAFROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\mu\) are: top-left \(\mu = 1\), top-right \(\mu = 2\), bottom-left \(\mu = 3\) and bottom-right \(\mu = 4\).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-mu-roc-1.pdf}
\caption{\label{fig:optim-op-point-low-performance-vary-mu-roc}Low performance varying \(\mu\) ROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\mu\) are: top-left \(\mu = 1\), top-right \(\mu = 2\), bottom-left \(\mu = 3\) and bottom-right \(\mu = 4\).}
\end{figure}

\hypertarget{optim-op-point-high-performance-vary-lambda}{%
\subsection{\texorpdfstring{High performance varying \(\lambda\)}{High performance varying \textbackslash lambda}}\label{optim-op-point-high-performance-vary-lambda}}
...
\caption{\label{tab:optim-op-point-high-performance-vary-lambda-table}Summary of optimization results for $\mu = 4$, $nu = 0.9$ and varying $\lambda$. Column labeling as in previous tables.}
\centering
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{llllll}
\toprule
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-lambda-froc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-lambda-wafroc-1.pdf}
\caption{\label{fig:optim-op-point-high-performance-vary-lambda-wafroc}High performance varying \(\lambda\) wAFROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\lambda\) are: top-left \(\lambda = 1\), top-right \(\lambda = 2\), bottom-left \(\lambda = 5\) and bottom-right \(\lambda = 10\).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-lambda-roc-1.pdf}
\caption{\label{fig:optim-op-point-high-performance-vary-lambda-roc}High performance varying \(\lambda\) ROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\lambda\) are: top-left \(\lambda = 1\), top-right \(\lambda = 2\), bottom-left \(\lambda = 5\) and bottom-right \(\lambda = 10\).}
\end{figure}

\hypertarget{optim-op-point-low-performance-vary-lambda}{%
\subsection{\texorpdfstring{Low performance varying \(\lambda\)}{Low performance varying \textbackslash lambda}}\label{optim-op-point-low-performance-vary-lambda}}
...
\caption{\label{tab:optim-op-point-low-performance-vary-lambda-table}Summary of optimization results for $\mu = 1$, $\nu = 0.2$ and varying $\lambda$. Column labeling as in previous tables.}
\centering
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{llllll}
\toprule
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-lambda-froc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-lambda-wafroc-1.pdf}
\caption{\label{fig:optim-op-point-low-performance-vary-lambda-wafroc}Low performance varying \(\lambda\) wAFROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\lambda\) are: top-left \(\lambda = 1\), top-right \(\lambda = 2\), bottom-left \(\lambda = 5\) and bottom-right \(\lambda = 10\).}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-lambda-roc-1.pdf}
\caption{\label{fig:optim-op-point-low-performance-vary-lambda-roc}Low performance varying \(\lambda\) ROC plots for the two optimization methods. The color coding is as in previous figures. The values of \(\lambda\) are: top-left \(\lambda = 1\), top-right \(\lambda = 2\), bottom-left \(\lambda = 5\) and bottom-right \(\lambda = 10\).}
\end{figure}

\hypertarget{optim-op-point-high-performance-vary-nu}{%
\subsection{\texorpdfstring{High performance varying \(\nu\)}{High performance varying \textbackslash nu}}\label{optim-op-point-high-performance-vary-nu}}
...
\caption{\label{tab:optim-op-point-high-performance-vary-nu-table}Summary of optimization results for $\mu = 4$, $\lambda = 1$ and varying $\nu$. Column labeling as in previous tables.}
\centering
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{llllll}
\toprule
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-nu-froc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-nu-wafroc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-high-performance-vary-nu-roc-1.pdf}
...
\caption{\label{tab:optim-op-point-low-performance-vary-nu-table}Summary of optimization results for $\mu = 1$, $\lambda = 10$ and varying $\nu$. Column labeling as in previous tables.}
\centering
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{llllll}
\toprule
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-nu-froc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-nu-wafroc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{22-optim-op-point2_files/figure-latex/optim-op-point-low-performance-vary-nu-roc-1.pdf}
