...
\begin{quote}
Search describes the process of \emph{finding} lesions while \emph{not finding} non-lesions.
\end{quote}
...
\section{TBA Discussion and suggestions}\label{froc-paradigm-discussion}}
