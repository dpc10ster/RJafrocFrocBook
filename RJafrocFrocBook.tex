...
\cline{3-4}
 &  & 6 & 0\\
\cline{3-4}
 & \multirow[t]{-7}{*}{\centering\arraybackslash c} & 7 & 0\\
\cline{2-4}
 &  & 8 & 1\\
\cline{3-4}
 &  & 9 & 1\\
\cline{3-4}
\multirow[t]{-10}{*}{\centering\arraybackslash \textbf{a}} & \multirow[t]{-3}{*}{\centering\arraybackslash d} & 10 & 0\\
\cline{1-4}
 &  & 11 & 1\\
\cline{3-4}
...
\cline{3-4}
 &  & 6 & 0\\
\cline{3-4}
 & \multirow[t]{-6}{*}{\centering\arraybackslash } & 7 & 0\\
\cline{2-4}
 & d & 8 & 1\\
\cline{2-4}
 &  & 9 & 1\\
\cline{3-4}
\multirow[t]{-9}{*}{\centering\arraybackslash \textbf{}} &  & 10 & 0\\
\cline{1-1}
\cline{3-4}
\textbf{b} &  & 11 & 1\\
\cline{1-1}
