...
The Youden-index is defined as sensitivity plus specificity minus 1. Sensitivity is implemented in function \texttt{RSM\_yROC} and specificity is \texttt{(1\ -\ RSM\_xROC)}.
...
\KeywordTok{cat}\NormalTok{(}\StringTok{"fitted values: mu = "}\NormalTok{, fit}\OperatorTok{$}\NormalTok{mu, }
    \StringTok{", lambda = "}\NormalTok{, fit}\OperatorTok{$}\NormalTok{lambdaP, }
    \StringTok{", nu = "}\NormalTok{, fit}\OperatorTok{$}\NormalTok{nuP, }\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\CommentTok{#> fitted values: mu =  2.755784 , lambda =  6.778332 , nu =  0.8033886}
\end{Highlighting}
\end{Shaded}
...
\midrule
 & 0.6 & 0.888 & 0.701 & 0.743 & (0.187, 0.520)\\
\cmidrule{2-6}
 & 0.7 & 0.674 & 0.751 & 0.793 & (0.250, 0.635)\\
\cmidrule{2-6}
 & 0.8 & 0.407 & 0.805 & 0.843 & (0.342, 0.756)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash wAFROC} & 0.9 & -0.007 & 0.864 & 0.892 & (0.503, 0.880)\\
\cmidrule{1-6}
 & 0.6 & 0.924 & 0.701 & 0.741 & (0.178, 0.515)\\
\cmidrule{2-6}
 & 0.7 & 0.924 & 0.748 & 0.782 & (0.178, 0.601)\\
\cmidrule{2-6}
 & 0.8 & 0.924 & 0.795 & 0.822 & (0.178, 0.687)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash Youden} & 0.9 & 0.924 & 0.843 & 0.862 & (0.178, 0.773)\\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
 & 1 & -1.663 & 0.745 & 0.806 & (0.952, 0.897)\\
\cmidrule{2-6}
 & 2 & -0.007 & 0.864 & 0.892 & (0.503, 0.880)\\
\cmidrule{2-6}
 & 3 & 0.808 & 0.922 & 0.933 & (0.210, 0.887)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash wAFROC} & 4 & 1.463 & 0.942 & 0.946 & (0.072, 0.895)\\
\cmidrule{1-6}
 & 1 & 0.245 & 0.717 & 0.775 & (0.403, 0.697)\\
\cmidrule{2-6}
 & 2 & 0.924 & 0.843 & 0.862 & (0.178, 0.773)\\
\cmidrule{2-6}
 & 3 & 1.478 & 0.910 & 0.916 & (0.070, 0.842)\\
\cmidrule{2-6}
\multirow{-4}{*}{\raggedright\arraybackslash Youden} & 4 & 1.994 & 0.938 & 0.939 & (0.023, 0.880)\\
\bottomrule
\end{tabular}}
\end{table}
...
\hypertarget{appendix-3-rsm-expression-for-youden-index}{%
\section{Appendix 3: RSM expression for Youden-index}\label{appendix-3-rsm-expression-for-youden-index}}

\begin{equation}
\text{FPF}\left (\zeta , \lambda\right ) = 1 - \text{exp}\left ( -\lambda \Phi\left ( -\zeta \right )  \right )
\label{eq:optim-op-rsm-pred-fpf}
\end{equation}
...
\end{aligned}
\right \}
\label{eq:optim-op-rsm-pred-tpf}
\end{equation}
...
\end{aligned}
\right \}
\label{eq:optim-op-rsm-pred-youden}
\end{equation}
