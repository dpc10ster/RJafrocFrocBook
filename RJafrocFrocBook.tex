...
\caption{Schematic showing the four observer performance paradigms. Arrows point to two lesions and light-shaded crosses indicate suspicious regions. Marked suspicious regions are indicated by dark-shaded crosses.}\label{fig:froc-paradigm-4}
\end{figure}
