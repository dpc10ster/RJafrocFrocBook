...
\chapter{FROC/wAFROC predictions of the RSM}\label{rsm-pred2}}
...
\section{Introduction}\label{rsm-pred2-intro}}
...
\section{The RSM-predicted FROC curve}\label{rsm-pred2-froc-curve}}
...
\hypertarget{slopes-near-origin-and-end-point}{%
\subsection{Slopes near origin and end-point}\label{slopes-near-origin-and-end-point}}
...
\begin{figure}
\centering
\includegraphics{08-rsm-predictions2_files/figure-latex/rsm-pred2-froc-plots-1.pdf}
\caption{\label{fig:rsm-pred2-froc-plots}RSM-predicted FROC curves. Top left: \(\mu = 0.0001\), \(\lambda = 1\) and \(\nu = 0.2\). Top right: \(\mu = 1\), \(\lambda = 2\) and \(\nu = 0.5\). Bottom left: \(\mu = 2\), \(\lambda = 3\) and \(\nu = 0.7\). Bottom right: \(\mu = 4\), \(\lambda = 4\) and \(\nu = 0.9\).}
\end{figure}

\hypertarget{rsm-pred2-froc-afroc-curve}{%
\section{The RSM-predicted AFROC curve}\label{rsm-pred2-froc-afroc-curve}}
...
\hypertarget{slopes-near-origin-and-end-point-1}{%
\subsection{Slopes near origin and end-point}\label{slopes-near-origin-and-end-point-1}}
...
\begin{figure}
\centering
\includegraphics{08-rsm-predictions2_files/figure-latex/rsm-pred2-afroc-plots-1.pdf}
\caption{\label{fig:rsm-pred2-afroc-plots}RSM-predicted AFROC curves for the same parameter values used in the earlier FROC plot. Top left: \(\mu = 0.0001\), \(\lambda = 1\) and \(\nu = 0.2\). Top right: \(\mu = 1\), \(\lambda = 2\) and \(\nu = 0.5\). Bottom left: \(\mu = 2\), \(\lambda = 3\) and \(\nu = 0.7\). Bottom right: \(\mu = 4\), \(\lambda = 4\) and \(\nu = 0.9\). As \(\mu\) increases the curve approaches the top-left corner. Each curve includes an inaccessible dashed linear extension to (1,1) and each plot is contained within the unit square which makes it easy to define the AUC as a figure of merit.}
\end{figure}
...
\hypertarget{rsm-pred2-froc-afroc-chance}{%
\subsection{Chance level performance on AFROC}\label{rsm-pred2-froc-afroc-chance}}
...
\subsection{The reader who does not yield any marks}\label{rsm-pred2-no-marks}}
...
\section{The RSM-predicted wAFROC curve}\label{rsm-pred2-wafroc-curve}}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\DecValTok{4}\NormalTok{) \{}
  \KeywordTok{cat}\NormalTok{(i, }\KeywordTok{all}\NormalTok{(plotArrwAfroc[[i]]}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{wLLF }\OperatorTok{>=}\StringTok{ }\NormalTok{plotArrAfroc[[i]]}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{LLF), }\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\DecValTok{4}\NormalTok{) \{}
  \KeywordTok{cat}\NormalTok{(i, }\KeywordTok{all}\NormalTok{(plotArrwAfrocZero[[i]]}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{wLLF }\OperatorTok{<=}\StringTok{ }\NormalTok{plotArrAfroc[[i]]}\OperatorTok{$}\NormalTok{data}\OperatorTok{$}\NormalTok{LLF), }\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
