...
\NormalTok{    mu, }
    \DataTypeTok{lambdaP =}\NormalTok{ lambdaP, }
    \DataTypeTok{nuP =}\NormalTok{ nuP, }
\NormalTok{    zeta1, }
\NormalTok{    lesDistr, }
...
\StringTok{    }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\KeywordTok{RSM_xROC}\NormalTok{(zeta1, lambdaP)) }\OperatorTok{-}\StringTok{ }\DecValTok{1}
...
\NormalTok{    x <-}\StringTok{ }\KeywordTok{UtilIntrinsic2PhysicalRSM}\NormalTok{(mu, }\DataTypeTok{lambda =}\NormalTok{ lambdaArr[i], nu)}
\NormalTok{    lambdaP <-}\StringTok{ }\NormalTok{x}\OperatorTok{$}\NormalTok{lambdaP}
\NormalTok{    nuP <-}\StringTok{ }\NormalTok{x}\OperatorTok{$}\NormalTok{nuP}
...
\NormalTok{      nlfOptArr[y,i] <-}\StringTok{ }\KeywordTok{RSM_xFROC}\NormalTok{(}
        ...
        \DataTypeTok{lambdaP =}\NormalTok{ lambdaP)}
\NormalTok{      llfOptArr[y,i] <-}\StringTok{ }\KeywordTok{RSM_yFROC}\NormalTok{(}
        \DataTypeTok{z =}\NormalTok{ x}\OperatorTok{$}\NormalTok{minimum, mu, nuP)}
...
\cmidrule{1-1}
\cmidrule{3-6}
Youden & \multirow{-2}{*}{\raggedright\arraybackslash 18.680} & 2.298 & 0.748 & 0.764 & (0.073, 0.543)\\
\bottomrule
\end{tabular}}
\end{table}
