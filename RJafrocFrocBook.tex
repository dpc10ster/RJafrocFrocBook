...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{kbl}\NormalTok{(df, }\DataTypeTok{align =} \StringTok{"c"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_paper}\NormalTok{(}\DataTypeTok{full_width =}\NormalTok{ F) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DataTypeTok{bold =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{collapse_rows}\NormalTok{(}\DataTypeTok{columns =} \DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{, }\DataTypeTok{valign =} \StringTok{"top"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\cline{1-4}
 &  & 11 & 1\\
\cline{3-4}
 & \multirow[t]{-2}{*}{\centering\arraybackslash c} & 12 & 1\\
\cline{2-4}
 &  & 13 & 0\\
\cline{3-4}
 &  & 14 & 1\\
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{collapse_rows_df <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(df, variable)\{}
\NormalTok{  group_var <-}\StringTok{ }\KeywordTok{enquo}\NormalTok{(variable)}
\NormalTok{  df }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(}\OperatorTok{!!}\StringTok{ }\NormalTok{group_var) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{groupRow =} \DecValTok{1}\OperatorTok{:}\KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\OperatorTok{!!}\KeywordTok{quo_name}\NormalTok{(group_var) }\OperatorTok{:}\ErrorTok{=}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(groupRow }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\KeywordTok{as.character}\NormalTok{(}\OperatorTok{!!}\StringTok{ }\NormalTok{group_var), }\StringTok{""}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{c}\NormalTok{(groupRow))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{kbl}\NormalTok{(}\KeywordTok{collapse_rows_df}\NormalTok{(}\KeywordTok{collapse_rows_df}\NormalTok{(df,C1), C2), }\DataTypeTok{align =} \StringTok{"c"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_paper}\NormalTok{(}\DataTypeTok{full_width =}\NormalTok{ F) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DataTypeTok{bold =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{collapse_rows}\NormalTok{(}\DataTypeTok{columns =} \DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{, }\DataTypeTok{valign =} \StringTok{"top"}\NormalTok{)}
\end{Highlighting}
...
\midrule
PCL\_0\_05 & 1T-RRFC & 0.45 & 0 & 0.493 & (0.418,0.568) & 0.0433 & (-0.0316,0.118) & 1.77 & 8 & 0.22\\
\cmidrule{1-11}
 & 2T-RRRC &  & (0.258,0.642) &  & (0.376,0.611) &  & (-0.157,0.244) & 0.179 & 784 & 0.67\\
\cmidrule{1-2}
\cmidrule{4-11}
 & 1T-RRRC & \multirow{-2}{*}{\raggedright\arraybackslash } & NA &  & (0.293,0.694) &  & (-0.157,0.244) & 0.179 & 784 & 0.67\\
\cmidrule{1-11}
PCL\_0\_2 & 1T-RRFC & 0.592 & 0 & 0.71 & (0.669,0.751) & 0.119 & (0.0778,0.159) & 45 & 8 & 0.000151\\
\cmidrule{1-11}
 & 2T-RRRC &  & (0.478,0.705) &  & (0.633,0.787) &  & (0.00445,0.233) & 4.16 & 937 & 0.042\\
\cmidrule{1-2}
\cmidrule{4-11}
 & 1T-RRRC & \multirow{-2}{*}{\raggedright\arraybackslash } & NA &  & (0.596,0.824) &  & (0.00445,0.233) & 4.16 & 937 & 0.042\\
\cmidrule{1-11}
PCL\_1 & 1T-RRFC & 0.675 & 0 & 0.783 & (0.74,0.827) & 0.108 & (0.0648,0.152) & 33 & 8 & 0.000433\\
\cmidrule{1-11}
 & 2T-RRRC &  & (0.571,0.779) &  & (0.712,0.854) &  & (0.0045,0.212) & 4.2 & 493 & 0.041\\
\cmidrule{1-2}
\cmidrule{4-11}
 & 1T-RRRC & \multirow{-2}{*}{\raggedright\arraybackslash } & NA &  & (0.68,0.887) &  & (0.0045,0.212) & 4.2 & 493 & 0.041\\
\cmidrule{1-11}
Wilcoxon & 1T-RRFC & 0.817 & 0 & 0.849 & (0.826,0.871) & 0.0317 & (0.00896,0.0545) & 10.3 & 8 & 0.0124\\
\cmidrule{1-11}
 & 2T-RRRC &  & (0.752,0.882) &  & (0.807,0.89) &  & (-0.031,0.0945) & 0.986 & 878 & 0.32\\
\cmidrule{1-2}
\cmidrule{4-11}
 & 1T-RRRC & \multirow{-2}{*}{\raggedright\arraybackslash } & NA &  & (0.786,0.911) &  & (-0.031,0.0945) & 0.986 & 878 & 0.32\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
 & 1T-RRFC & 0.0095 & NA & NA & NA & NA & NA\\
\cmidrule{2-8}
 & 2T-RRRC & 0.00000000000000000184 & -0.00571 & 0.00131 & 0.00601 & 0.00131 & 0.0165\\
\cmidrule{2-8}
\multirow{-3}{*}{\raggedright\arraybackslash PCL\_0\_05} & 1T-RRRC & 0.0095 & NA & NA & 0.0094 & NA & 0.0303\\
\cmidrule{1-8}
 & 1T-RRFC & 0.00281 & NA & NA & NA & NA & NA\\
\cmidrule{2-8}
 & 2T-RRRC & -0.000000000000000000759 & 0.000265 & 0.000761 & 0.00229 & 0.000761 & 0.00343\\
\cmidrule{2-8}
\multirow{-3}{*}{\raggedright\arraybackslash PCL\_0\_2} & 1T-RRRC & 0.00281 & NA & NA & 0.00307 & NA & 0.00534\\
\cmidrule{1-8}
 & 1T-RRFC & 0.0032 & NA & NA & NA & NA & NA\\
\cmidrule{2-8}
 & 2T-RRRC & 0.00000000000000000163 & 0.001 & 0.000643 & 0.00186 & 0.000643 & 0.00246\\
\cmidrule{2-8}
\multirow{-3}{*}{\raggedright\arraybackslash PCL\_1} & 1T-RRRC & 0.0032 & NA & NA & 0.00244 & NA & 0.00364\\
\cmidrule{1-8}
 & 1T-RRFC & 0.000878 & NA & NA & NA & NA & NA\\
\cmidrule{2-8}
 & 2T-RRRC & 0.000000000000000000298 & 0.000201 & 0.000262 & 0.000724 & 0.000262 & 0.000962\\
\cmidrule{2-8}
\multirow{-3}{*}{\raggedright\arraybackslash Wilcoxon} & 1T-RRRC & 0.000878 & NA & NA & 0.000924 & NA & 0.0014\\
\bottomrule
\end{tabular}}
\end{table}
