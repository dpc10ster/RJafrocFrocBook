...
\hypertarget{figures-of-merit-to-be-maximized}{%
\section{Figures of merit to be maximized}\label{figures-of-merit-to-be-maximized}}

The wAFROC figure of merit is implemented in the \texttt{RJafroc} function \texttt{UtilAnalyticalAucsRSM}. It was assumed that half of the diseased cases contain one lesion and the rest contain two lesions and the lesions are assigned equal weights (i.e., clinical importance).
...
\caption{\label{fig:optim-op-point-vary-lambda-froc}FROC plots with superimposed operating points for varying \(\lambda\). The black dot is when maximized wAFROC AUC was used to find the optimal operating point and red dot is when maximized Youden-index was used.}
\end{figure}
...
\caption{\label{fig:optim-op-point-vary-lambda-wafroc}wAFROC plots for the two optimization methods: the green-red-red-dashed curve corresponds to wAFROC-AUC optimization and the green-green curve corresponds to Youden-index optimization.}
\end{figure}
...
\hypertarget{illustrative-froc-plots-1}{%
\subsection{Illustrative FROC plots}\label{illustrative-froc-plots-1}}
...
\caption{\label{fig:optim-op-point-vary-nu-froc}FROC plots with superimposed operating points for varying \(\nu\). The black dot is when maximized wAFROC AUC was used to find the optimal operating point and red dot is when maximized Youden-index was used.}
\end{figure}
...
\hypertarget{illustrative-froc-plots-2}{%
\subsection{Illustrative FROC plots}\label{illustrative-froc-plots-2}}
...
\caption{\label{fig:optim-op-point-vary-mu-froc}FROC plots with superimposed operating points for varying \(\mu\). The black dot is when maximized wAFROC AUC was used to find the optimal operating point and red dot is when maximized Youden-index was used.}
\end{figure}

TBA These plots illustrate the previous comments, namely, as \(\lambda\) increases, the optimal operating point moves \emph{down} the scaled curve corresponding to adoption of progressively more stringent reporting thresholds.

\hypertarget{illustrative-wafroc-plots-2}{%
\subsection{Illustrative wAFROC plots}\label{illustrative-wafroc-plots-2}}
...
\hypertarget{illustrative-roc-plots-2}{%
\subsection{Illustrative ROC plots}\label{illustrative-roc-plots-2}}
