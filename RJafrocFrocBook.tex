...
Shown next is the \texttt{NL} ratings array; it has 8 rows, corresponding to the total number of cases, and 2 columns, corresponding to the maximum number of NLs and LLs per case (notice there are two entries for case \#3). The negative infinities represent unmarked locations.
